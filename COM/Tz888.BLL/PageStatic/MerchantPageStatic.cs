        ...
        public bool CreateStaticPageMerchant(string InfoID,ref string UpdateMsg)
        {
            ...
            try
            {
                ...
                if (arrListPic.Count > 5)
                {
                    ...
                    Pic6_r = "<li id=\"tab_tophome_6\" class=\"out\"><a href=\"#\"  onmousemove=\"startIndex=6;setTab('tophome',6,6,'out','on');\" onclick=\"javascript:pgvSendClick({hottag:'KF.SERVICE.INDEX.SOSO_2'});\"><img src=" + MerchantPicPath.Trim() + Pic6_s.Trim() + " class=\"tab_img\" alt=\"4\"/></a></li>";
