...
namespace Tz888.BLL.Info
{
    public class ProjectInfoBLL
    {
        ...
        {
            return dal.ProjectInfoZQ_Update_Up(model,infoResourceModels);
        }
        /// <summary>
        /// 后台审核中用
        /// </summary>
        ...
        {
            return dal.ProjectInfoGQ_Update_Up(model, infoResourceModels);
        }
        public string selInfoIdRegion(int beginfo, int endinfo)
        {
            return dal.selInfoIdRegion(beginfo, endinfo);
        }
    }
}
