...
namespace Tz888.BLL
{
    public class SendNotice
    {
        ...
        Tz888.SQLServerDAL.SendNotice dal = new Tz888.SQLServerDAL.SendNotice();
        Tz888.SQLServerDAL.Info.MainInfoDAL Member = new Tz888.SQLServerDAL.Info.MainInfoDAL();
        Tz888.SQLServerDAL.Conn dalConn = new Tz888.SQLServerDAL.Conn();
        ...
        public int SendSms(string Model, string Contnts)
        {
            ...
            int i =0;//' bs.sendBatchMessage(SmsUser, SmsPass, Model, Contnts);
            return i;
        }
