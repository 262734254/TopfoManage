...
namespace Tz888.BLL.Sys
{
    ...
    {
        private readonly IEmployeeInfoTab dal = DataAccess.CreateEmployeeInfoTab();
        ...
        /// 得到一个对象实体，从缓存中。
        /// </summary>
        public Tz888.Model.Sys.EmployeeInfoTab GetModelByCache(int EmployeeID)
        {

            string CacheKey = "EmployeeInfoTabModel-" + EmployeeID;
            object objModel = dal.GetModel(EmployeeID);

            return (Tz888.Model.Sys.EmployeeInfoTab)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Tz888.Model.Sys.EmployeeInfoTab> GetModelList(string strWhere)
        {
        ...
        /// <returns></returns>
        public int Insert(Tz888.Model.Sys.EmployeeInfoTab empMode, string strTem)
        {
