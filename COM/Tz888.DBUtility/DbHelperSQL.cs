...
namespace Tz888.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        protected static String connectionString4 = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        ...
        /// <returns>DataSet</returns>
        public static DataSet RunProcedureCRM(string storedProcName, IDataParameter[] parameters, string tableName)
        {
