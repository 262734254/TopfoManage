...
namespace Tz888.DBUtility
{
    ...
    /// </summary>
    public abstract class SearchDBHelper
    {
        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
        protected static String connectionString = ConfigurationManager.ConnectionStrings["SearcalConnString"].ConnectionString;
