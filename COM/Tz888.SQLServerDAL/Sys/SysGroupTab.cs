...
namespace Tz888.SQLServerDAL.Sys
{
    ...
    /// 数据访问类SysGroupTab。
    /// </summary>
    public class SysGroupTab : ISysGroupTab
    {
        public SysGroupTab()
        { }
        #region  成员方法
        ...
        /// 得到一个对象实体
        /// </summary>
        public Tz888.Model.Sys.SysGroupTab GetModel(int SGID)
        {
            ...
            Tz888.Model.Sys.SysGroupTab model = new Tz888.Model.Sys.SysGroupTab();
