...
namespace Tz888.SQLServerDAL.dp
{
    ...
    public class SysRoleTab : ISysRoleTab
    {
        ...
        public void Check(int SRoleID)
        {
            ...
            crm.ExecuteSqls(strsql.ToString(), para);
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select a.userName,a.TypeName,a.Mobile,a.Email ");
            strSql.Append("from dbo.CompanyShow  a join system b on  a.userName=b.EmployeeID");
            if (tem.Trim() != "")
            {
        ...
        public string GetNameByID(string IndustryID)
        {
            ...
            return crm.Querys(strSql.ToString()).Tables[0].Rows[0][0].ToString();
