    ...
    public class common : Tz888.IDAL.Register.common  
    {
       ...
       #region 公司登记图片
        ...
        public Tz888.Model.Register.MemberInfoModel SelorgContact(string lognName)
        {
            ...
            para[0].Value = name;
            ds = Tz888.DBUtility.DbHelperSQL.Query(sql, para);
            //if (ds.Tables[0].Rows.Count == 0)
            //{
            //    string sqll = "select NickName,Tel,Mobile,Email from MemberInfoTab where LoginName like '"+name+"%'";
            //    DataSet dss = Tz888.DBUtility.DbHelperSQL.Query(sqll);
            //    if (dss != null & dss.Tables[0].Rows.Count > 0)
            //    {
            //        org.NickName = dss.Tables[0].Rows[0]["NickName"].ToString();
            //        org.Tel = dss.Tables[0].Rows[0]["Tel"].ToString();
            //        org.Mobile = dss.Tables[0].Rows[0]["Mobile"].ToString();
            //        org.Email = dss.Tables[0].Rows[0]["Email"].ToString();
            //    }
            //}
            //else
            //{
