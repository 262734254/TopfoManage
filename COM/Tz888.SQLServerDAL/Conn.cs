    ...
    public class Conn : IConn
    {
            ...
            int OrderType, string strWhere)
        {
            ...
            try
            {
                ...
                else { ds = DbHelperSQL.RunProcedure("Sp_Conn_Sort", Parameters, "ds"); }
            }
            catch (Exception err)
            {
                throw err;
        ...
        public int GetCountFN(string tblName, string fldName, string strWhere)
        {
            ...
            if (name.Length ==2)
            {
                ds = DBHelper.RunProcedure("Sp_Conn_Sort_FN", Parameters, "ds");
            }
            else if (name.Length == 3)
            {
                ds = DBHelpers.RunProcedure("Sp_Conn_Sort", Parameters, "ds");
            }
            else { ds = DbHelperSQL.RunProcedure("Sp_Conn_Sort_FN", Parameters, "ds"); }
            ...
            ref long CurrentPage, long PageSize, ref long TotalCount)
        {
            ...
            string[] name = TableViewName.Split(',');
            string namess = name[0];
            parameters[0].Value = namess;
            ...
            if (name.Length ==2)
            {
                ds = DBHelper.RunProcedure("GetDataList_FN", parameters, "ds");
            }
            else if (name.Length == 3)
            {
                ds = DBHelpers.RunProcedure("GetDataList_FN", parameters, "ds");
            }
            else { ds = DbHelperSQL.RunProcedure("GetDataList_FN", parameters, "ds"); }
        ...
        public bool  Delect(string tblName, string where )
        {
            ...
            if (name.Length ==2)
            {
                return  DBHelper.RunProcLob("DelectCommon", Parameters);
            }
            else if (name.Length == 3)
            {
                return DBHelpers.RunProcLob("DelectCommon", Parameters);
            }
            else { return DbHelperSQL.RunProcLob("DelectCommon", Parameters); }
            ...
            int OrderType, string strWhere)
        {
            ...
            else { ds = DbHelperSQL.GetWebSiteList("Sp_Conn_Sort", Parameters, "ds"); }
            ...
            ref long CurrentPage, long PageSize,ref long TotalCount)
        {
            ...
            if (name.Length ==2)
            {
                ds = DBHelper.RunProcedure("GetDataList", parameters, "ds");
            }
            else if (name.Length == 3)
            {
                ds = DBHelpers.RunProcedure("GetDataList", parameters, "ds");
            }
            else { ds = DbHelperSQL.RunProcedure("GetDataList", parameters, "ds"); }
