...
namespace GZS.DAL.Menu
{
    ...
    public class EmployeeInfoTab
    {
        ...
        public GZS.Model.Menu.EmployeeInfoTab GetModel(int EmployeeID)
        {
            ...
            GZS.Model.Menu.EmployeeInfoTab model = new GZS.Model.Menu.EmployeeInfoTab();
        ...
        //同时向两个表插入数据
        public int Add(Tz888.Model.LoginInfo loginModel, GZS.Model.Menu.EmployeeInfoTab empModel, string strTem)
        {
            //Employeeinfotab表
        ...
        /// <returns></returns>
        public int Insert(GZS.Model.Menu.EmployeeInfoTab empModel, string strTem)
        {
            //Employeeinfotab表
            StringBuilder SqlTxtEmployee = new StringBuilder();
        ...
        {
            GZS.Model.Menu.EmployeeInfoTab empModel = new GZS.Model.Menu.EmployeeInfoTab();
            SqlParameter[] para ={
                                    new SqlParameter("@LoginName",SqlDbType.VarChar,20),
                                    new SqlParameter("@LoginPwd",SqlDbType.VarBinary) 
                                 };
