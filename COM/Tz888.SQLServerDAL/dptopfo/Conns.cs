   ...
   public class Conns
   {
    /// <summary>
        ...
        public DataTable GetList(string FileName, string TableName, string Where)
        {
            ...
            try
            {
                ds = DBHelpers.RunProcedure("Conn", parameters, "ds");
            }
            catch (Exception err)
            {
                throw err;
        ...
        public int GetCount(string tblName, string fldName, string strWhere)
        {
            ...
            DataSet ds = DBHelpers.RunProcedure("Sp_Conn_Sort", Parameters, "ds");
        ...
        public int GetCountFN(string tblName, string fldName, string strWhere)
        {
            ...
            DataSet ds = DBHelpers.RunProcedure("Sp_Conn_Sort_FN", Parameters, "ds");
            ...
            ref long CurrentPage, long PageSize, ref long TotalCount)
        {
            ...
            DataSet ds = DBHelpers.RunProcedure("GetDataList_FN", parameters, "ds");
            ...
            ref long CurrentPage, long PageSize, ref long TotalCount)
        {
            ...
            DataSet ds = DBHelpers.RunProcedure("GetDataList", parameters, "ds");
