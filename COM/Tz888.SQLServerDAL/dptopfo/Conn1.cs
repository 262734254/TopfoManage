...
namespace GZS.DAL
{
    public class Conn1
    {
        ...
        public DataTable GetList(string FileName, string TableName, string Where)
        {
            ...
            try
            {
                ds = DBHelper.RunProcedure("Conn", parameters, "ds");
            }
            catch (Exception err)
            {
                throw err;
        ...
        public int GetCount(string tblName, string fldName, string strWhere)
        {
            ...
            DataSet ds = DBHelper.RunProcedure("Sp_Conn_Sort", Parameters, "ds");
        ...
        public int GetCountFN(string tblName, string fldName, string strWhere)
        {
            ...
            DataSet ds = DBHelper.RunProcedure("Sp_Conn_Sort_FN", Parameters, "ds");
            ...
            ref long CurrentPage, long PageSize, ref long TotalCount)
        {
            ...
            DataSet ds = DBHelper.RunProcedure("GetDataList_FN", parameters, "ds");
        ...
        public bool Update(int psid, int IsChekUp)
        {
            ...
            return DBHelper.RunProcLob("RCUpdate", parameters);
            ...
            )
        {
            ...
            DataSet ds = DBHelper.RunProcedure(SPName, parameters, "ds");
