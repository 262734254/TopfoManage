...
namespace Tz888.IDAL.Info
{
    ...
    public interface IProjectInfo
    {
        ...
        bool ProjectInfoZQ_Update_Up(Tz888.Model.Info.ProjectSetModel model, List<Tz888.Model.Info.InfoResourceModel> infoResourceModels);//后台审核中用

        bool ProjectInfoGQ_Update_Up(Tz888.Model.Info.ProjectSetModel model, List<Tz888.Model.Info.InfoResourceModel> infoResourceModels);//后台审核中用
        /// 删除融资信息
        ...
        /// 根据编号区间查询所对于的编号
        /// </summary>
        string selInfoIdRegion(int beginfo, int endinfo);
    }
}
