...
namespace Tz888.IDAL.Subject
{
    public  interface ISubjectExtend
    {
        ...
        /// <returns></returns>
        int AddExtendAddress(ExtendAddressModel model);
        /// <summary>
        /// 修改推广位置信息
        /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        int UpdateExtendAddress(ExtendAddressModel model, int id);
        /// <summary>
        /// 删除推广位置信息
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        int DelExtendAddress(int id);
        /// <summary>
        /// 根据编号查询出所对应的信息
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ExtendAddressModel SelExtendAddress(int id);
