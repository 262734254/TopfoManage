<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherManage.aspx.cs" Inherits="wyzs_OtherManage" %>
...
function shenhe(idd)
{
      ...
      url="AddOther.aspx?alt=1&id="+idd;
      window.location.href = url;
                ...
                <tr>
                    <td style="height: 26px">
                        <div class="pagebox" style="text-align: left">
                            <input type="button" value="录入信息" class="btn" onclick="javascript:location.href='AddOther.aspx'"
                                id="Button2" />
                        </div>
                    </td>
                    <td>
