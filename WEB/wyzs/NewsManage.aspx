<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsManage.aspx.cs" Inherits="wyzs_NewsManage" %>
                ...
                <tr>
                    <td style="height: 26px">
                        <div class="pagebox" style="text-align: left">
                            <input type="button" value="录入信息" class="btn" onclick="javascript:location.href='AddNews.aspx'"
                                id="Button2" />
                        </div>
                    </td>
                    <td>
