<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ServiceManage.aspx.cs" Inherits="wyzs_ServiceManage" %>
...
function shenhe(idd)
{
      ...
      url="AddService.aspx?alt=1&id="+idd;
      window.location.href = url;
                ...
                <tr>
                    <td style="height: 26px">
                        <div class="pagebox" style="text-align: left">
                            <input type="button" value="录入信息" class="btn" onclick="javascript:location.href='AddService.aspx'"
                                id="Button2" />
                        </div>
                    </td>
                    <td>
