<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecommManage.aspx.cs" Inherits="wyzs_RecommManage" %>
...
function shenhe(idd)
{
      ...
      url="AddRecomm.aspx?alt=1&id="+idd;
      window.location.href = url;
                ...
                <tr>
                    <td style="height: 26px">
                        <div class="pagebox" style="text-align: left">
                            <input type="button" value="录入信息" class="btn" onclick="javascript:location.href='AddRecomm.aspx'"
                                id="Button2" />
                        </div>
                    </td>
                    <td>
