<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddWyzsInfo.aspx.cs" Inherits="wyzs_AddWyzsInfo" %>
...
<body>
    <form id="form1" runat="server">
        <div class="title" align="center">
            ...
            <h2><p><span><b>物业信息发布</b></span></p></h2>
        </div>
        <table width="100%" cellpadding="0" cellspacing="0" class="one_table">
            ...
            <tr>
                <td align="right" class="f_td"><span class="f_red">*</span>联系电话：</td>
                <td><input id="txtTelePhone" onkeyup="value=value.replace(/[^0-9]/g,'')" onblur="value=value.replace(/[^0-9]/g,'')" runat="server" type="text" style="width: 238px; height: 20px" /></td>
            </tr>
            <tr>
