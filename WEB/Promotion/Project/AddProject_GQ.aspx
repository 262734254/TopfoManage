<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddProject_GQ.aspx.cs" Inherits="Project_AddProject_GQ" %>
...
//	          return false;
//	   }
	   if(document.getElementById("txtXmqxms").value=="")
	   {
	       alert("请填写项目详细描述");
	       document.getElementById("txtXmqxms").focus();
	       return false;
	   }
...
<body>
    ...
    <div class="title" align="center">
             ...
             <h2><p><span><b><a href="#">发布股权信息</a></b></span></p></h2>
              <h2><p><span><b><a href="AddProject_Zq.aspx">发布债券信息</a></b></span></p></h2>
             </div>
    <table width="100%" class="one_table" border="0" cellspacing="0" cellpadding="0">
      ...
      <span id="spPosition"></span>
            ...
            <tr>
                <td width="20%" align="right">
                    <span class="f_red"></span> <strong>手机：</strong></td>
                <td>
                ...
                <td colspan="2">
                    <asp:Panel ID="plAudit" Width="100%" runat="server">
                        <table width="100%" border="0" align="center" class="one_table"  cellpadding="1" cellspacing="1">
                            <tr>
                                <td width="20%" align="right" style="height: 22px" >
                                    <span class="f_red">*</span> <strong>审核结果：</strong></td>
                                <td width="625" style="height: 22px" >
                          ...
                          <span id="span1" runat="server" style="display:none">
                            ...
                            <tr>
                                <td width="20%" align="right" style="height: 26px" >
                                    <span class="hong">&nbsp;</span><strong>资源选项：</strong></td>
                                <td width="80%" align="left" style="height: 26px">
                                    ...
                                    <span id="span5" style="display: none" runat="server">
                                        <asp:TextBox ID="txtPointCount" onkeyup="value=value.replace(/[^\d]/g,'') " runat="server" >0</asp:TextBox>
                                        元</span></td>
                            </tr>
                          </span>
                        </table>
            ...
            <tr>
                <td align="center" colspan="2">
                    <asp:Button ID="btnOk" runat="server" CssClass="btn" Text="添加" OnClientClick="return chkBtn();" OnClick="btnIssueOK_Click"  />
