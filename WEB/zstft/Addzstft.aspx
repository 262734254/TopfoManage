<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Addzstft.aspx.cs" Inherits="zstft_Addzstft" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
       function CheckNull()
       {
          ...
          var Img=document.getElementById("FileUpload1");
          if(Trim(Img.value)=="")
          {
             alert("上传文件不能为空!");
             Img.focus();
