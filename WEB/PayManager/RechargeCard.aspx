<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RechargeCard.aspx.cs" Inherits="PayManager_RechargeCard" %>
...
<body>
   ...
   <div class="title" align="center">
             ...
             <h2><p><span><b>充值卡在线充值</b></span></p></h2>
             </div>
       <table width="100%" cellpadding="0" cellspacing="0" class="one_table">
                <tr>
                    <td align="right" class="f_td" style="height: 24px">
                        <span class="f_red">*<span style="color: #000000; background-color: #f7f7f7">充值帐号</span></span>：</td>
           ...
           <tr>
               <td align="right" class="f_td">
                <span class="f_red">*<span style="color: #000000; background-color: #f7f7f7">充值卡号</span></span>：</td>
               <td>
               <span runat="server" id="span1" class="f_red">
                            <asp:TextBox ID="txtNumber" runat="server"></asp:TextBox></span></td>
           </tr>
           
           
             <tr>
               <td align="right" class="f_td">
                <span class="f_red">*<span style="color: #000000; background-color: #f7f7f7">充值卡密码</span></span>：</td>
               <td>
               <span runat="server" id="span2" class="f_red">
                            <asp:TextBox ID="txtpassword" runat="server" TextMode="Password" ></asp:TextBox></span></td>
           </tr>
           <tr>
               <td align="right" class="f_td">
               ...
               <td>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Button runat="server" ID="btnStatus" Text="充 值" OnClientClick="return Depath();" CssClass="btn" OnClick="btnStatus_Click"  />
                        &nbsp &nbsp &nbsp;&nbsp;
                    </td>
                </tr>
            </table>
