<%@ Page Language="C#" AutoEventWireup="true" CodeFile="strike_end.aspx.cs" Inherits="PayManager_strike_end" %>
                ...
                <td valign="top" width="100%">
                    <div>
                      <div class="title">
                            <h2>
                                <p>
                                    <span><a href="strike_wait.aspx"><b>已完成的充值</b></a></span></p>
                            </h2>
                            <h2>
                                <p>
                                    <span><b>未完成的充值</b></span></p>
                            </h2>
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="button" name="Submit23" onclick="ReSelect()" value="反选" class="buttomal" /><a class="bluelink"
                                                        href="javascript:chkAll2()"><span style="color: #0000ff"></span></a></td>
                                                <td align="right">
                                                    <span style="color: #ff0000">
                                                    完成充值总金额：</span><asp:Label ID="lblPoint" runat="server" ForeColor="Red">0.00</asp:Label><span
                                                        style="color: #ff0000">元</span> &nbsp;共<asp:Literal ID="lblCount" runat="server" Text="0"></asp:Literal>条 页次：<asp:Literal
