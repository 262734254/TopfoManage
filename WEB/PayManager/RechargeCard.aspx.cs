...
public partial class PayManager_RechargeCard : System.Web.UI.Page
{

    BasePage bp = new BasePage();
    protected void Page_Load(object sender, EventArgs e)
    {
        txtByName.Text = "tz888admin";//bp.LoginName;
    }
    protected void btnStatus_Click(object sender, EventArgs e)
    {
        string LoginName = "tz888admin";//bp.LoginName;
                ...
                if (passresult > 0)
                {
                    ...
                    if (state == 0)
                    {
                        ...
                        if (orderno > 0)
                        {
                            ...
                            bool b = dall.RechargeCardSuccess(Convert.ToString(orderno), "Card", "", LoginName, txtNumber.Text.ToString().Trim(), Convert.ToInt32(sType.Value.Trim()));
                            if (b)
                            {
