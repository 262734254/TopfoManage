<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trade_info_wait.aspx.cs" Inherits="PayManager_trade_info_wait" %>
                ...
                <td valign="top" width="100%">
                    <div class="rightBlock">
                         ...
                         <div class="title">
                            <h2>
                                <p>
                                    <span><a href="strike_wait.aspx"><b>订单管理</b></a></span></p>
                            </h2>
                            <h2>
                                <p>
                                    <span><b><a href="trade_info_list.aspx">已完成交易</a></b></span></p>
                            </h2>
                            ...
                            <table border="0" cellpadding="0" cellspacing="1" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="height: 30px" width="85%">
                                        ...
                                        </select><strong>支付方式：</strong><select id="sType" runat="server" name="sType">
                        ...
                        <img onclick="WdatePicker({el:$dp.$('txtEndTime')})" src="../My97DatePicker/skin/datePicker.gif" align="absmiddle" style="cursor:pointer" /></td>
                                ...
                                <tr style="color: #0000ff">
                                    <td class="tdright f14b">
                                        关键字搜索：</td>
                                    <td >
                                        <input  name="textfield22" type="text" runat="server"
                                            id="txtTitle" /></td>
                                </tr>
                                <tr style="color: #0000ff">
                                    <td class="tdright f14b">
                                ...
                                <tr>
                                    <td align="center" colspan="4">
                                        <asp:Button ID="btnSearch" class="buttomal" runat="server" Text="查  询" OnClick="btnSearch_Click" /></td>
                                </tr>
                            </table>
                        </div>
                        <div class="hrline">
                        ...
                        <div class="alltablebg">
                           <table border="0" cellpadding="0" cellspacing="0" align="center" class="one_table" >
                               <tr  style="background:#bcd9e7; height:27px;">
                                    ...
                                    <td class="bg1" width="5%" align="center">
                                        类别</td>
                                   <td  class="bg1" width="10%" align="center">订单号</td>
                                    <td class="bg1" width="23%" align="center">
                                        资源标题</td>
                                    ...
                                    <td class="bg1" width="16%" align="center">
                                        生成时间</td>
                                    <td class="bg1" width="15%" align="center">
                                        订单管理</td>
                                </tr>
                                <asp:Repeater runat="server" ID="myList">
                                    <ItemTemplate>
                                         <tr  onmouseover="this.style.backgroundColor='#f5f5f5';" onmouseout="this.style.backgroundColor=''" >
                                            <td align="center">
                                                <input name="checkbox" type="checkbox" value="<%#Eval("ShopCarID") %>" /></td>
                                            <td align="center">
                                                <%#Eval("InfoTypeName") %>
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <%#GetPoint(Eval("WorthPoint", "{0:N}"), Eval("DisWorthPoint", "{0:N}"))%>
                                                元</td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <a class="bluelink" href="trade_info_details.aspx?ID=<%#Eval("OrderNo") %>&status=0">
                                                    <span style="color: #0000ff">查看订单</span></a> | <a class="bluelink" href="trade_info_confirmed.aspx?ID=<%#Eval("OrderNo") %>">
                                                       <%-- <span style="color: #0000ff">确认付款</span></a>--%>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                                <tr>
                                    <td colspan="8" style="height: 53px">
                                     <table border="0" cellpadding="0" cellspacing="0" align="center" class="one_table" >
                                            <tr>
                                                <td>
                                                    ...
                                                    <input name="Submit" type="button" onclick="deletechk()" class="buttomal" value="删 除" /><input
                                                        name="Submit2" type="button" onclick="alert('功能开发中……')" class="buttomal" value="导 出" />
                                                </td>
                                                <td align="right">
