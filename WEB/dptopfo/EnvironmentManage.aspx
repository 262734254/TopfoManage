<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnvironmentManage.aspx.cs" Inherits="dptopfo_EnvironmentManage" %>

<%@ Register Assembly="Tz888.Pager" Namespace="Tz888.Pager" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>投资环境列表信息</title>
...
//1服务2机构3专业人才
function modifyNavigate(pid,name)
{
    var url="";
   
    url="EnvironmentTabInsert.aspx?EnvironmentTypeid="+pid+"&LoginName="+name;
                ...
                <asp:Repeater ID="NewsList" OnItemDataBound="NewsList_ItemDataBound" runat="server">
                    <ItemTemplate>
                        <tr onmouseover="this.style.backgroundColor='#f5f5f5';" onmouseout="this.style.backgroundColor=''">
                            <%--<td >
                                <label>
                                    <input type="checkbox" name="cbxSelect" id="cbxSelect" value="<%#Eval("Environmentid")%>" />
                                </label>
                            </td>--%>
                            <td>
                                <%#Eval("Environmentid")%>
                            ...
                            <td>
                            <a href='http://<%#Eval("loginName") %>.topfo.com/Investmentenvironment.htm'; target="_blank">查看</a> 
                                <a href='JavaScript:modifyNavigate("<%#Eval("EnvironmentTypeid") %>","<%#Eval("loginName") %>");'>修改</a> 
                               <%-- <a href='JavaScript:DelNav("<%#Eval("Environmentid") %>");');' onclick="return confirm('确认要删除吗？') ">删除</a>--%>
