...
public partial class dptopfo_ProductManage : System.Web.UI.Page
{
    ...
    private void GetInfoNews()
    {
        ...
        long TotalCount = 0;
        long PageCount = 1;
        DataTable ds = manager.GetListTS("produceDomin", "productid", "*", strCriteria, "createdate desc", ref CurrentPage, PageNum, ref TotalCount);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (strCriteria.ToString() == "")
        {
            if (this.txtNuber.Value.Trim() != "")   //根据ID
                strCriteria.Append(" productid like  '%" + this.txtNuber.Value.Trim() + "%'");
        }
