<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ParkManage.aspx.cs" Inherits="dptopfo_ParkManage" %>

<%@ Register Assembly="Tz888.Pager" Namespace="Tz888.Pager" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>园区特色列表信息</title>
...
function modifyNavigate(pid,name)
{
    ...
    url="AddPark.aspx?parktypeid="+pid+"&name="+name;;
                ...
                <asp:Repeater ID="NewsList" OnItemDataBound="NewsList_ItemDataBound" runat="server">
                    <ItemTemplate>
                        <tr onmouseover="this.style.backgroundColor='#f5f5f5';" onmouseout="this.style.backgroundColor=''">
                            <%--<td >
                                <label>
                                    <input type="checkbox" name="cbxSelect" id="cbxSelect" value="<%#Eval("parkid")%>" />
                                </label>
                            </td>--%>
                            <td>
                                <%#Eval("parkid")%>
                            ...
                            <td>
                            <a href='http://<%#Eval("loginName") %>.topfo.com/Park.htm'; target="_blank">查看</a> 
                                <a href='JavaScript:modifyNavigate("<%#Eval("parktypeid") %>","<%#Eval("loginName") %>");'>修改</a> 
                               <%-- <a href='JavaScript:DelNav("<%#Eval("parkid") %>");');' onclick="return confirm('确认要删除吗？') ">删除</a>--%>
