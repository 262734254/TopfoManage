...
public partial class dptopfo_CommentMange : System.Web.UI.Page
{
    ...
    private void GetInfoNews()
    {
        ...
        long TotalCount = 0;
        long PageCount = 1;
        DataTable ds = manager.GetListTS("CommentTab", "CommentId", "*", strCriteria, "CommDate desc", ref CurrentPage, PageNum, ref TotalCount);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (strCriteria.ToString() == "")
        {
            if (this.txtNuber.Value.Trim() != "")   //根据ID
                strCriteria.Append(" CommentId like  '%" + this.txtNuber.Value.Trim() + "%'");
        }
        ...
        if (strCriteria.ToString() == "")
        {
            ...
            {
                strCriteria.Append("SendName='" + LoginName + "'");
            }
            else
            {
