<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommentMange.aspx.cs" Inherits="dptopfo_CommentMange" %>
...
function modifyNavigate(pid)
{
    ...
    url="AddComm.aspx.aspx?CommID="+pid;
                ...
                <asp:Repeater ID="NewsList" OnItemDataBound="NewsList_ItemDataBound" runat="server">
                    <ItemTemplate>
                        <tr onmouseover="this.style.backgroundColor='#f5f5f5';" onmouseout="this.style.backgroundColor=''">
                           <%-- <td >
                                <label>
                                    <input type="checkbox" name="cbxSelect" id="cbxSelect" value="<%#Eval("CommentId")%>" />
                                </label>
                            </td>--%>
                            <td>
                                <%#Eval("CommentId")%>
                            ...
                            <td>
                                <%#Convert.ToDateTime(Eval("CommDate")).ToString("yyyy-MM-dd (hh:mm)")%>
                            </td>
                            <td>
                            <a href='http://<%#Eval("SendName") %>.topfo.com/contact.htm'; target="_blank">查看</a> 
                                <%--<a href='JavaScript:modifyNavigate("<%#Eval("CommentId") %>");'>修改</a> --%>
                                <%--<a href='JavaScript:DelNav("<%#Eval("CommentId") %>");');' onclick="return confirm('确认要删除吗？') ">删除</a>--%>
