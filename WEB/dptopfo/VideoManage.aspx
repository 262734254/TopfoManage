<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VideoManage.aspx.cs" Inherits="dptopfo_VideoManage" %>
...
function modifyNavigate(pid,name)
{
    ...
    url="VideoSysUpdate.aspx?VideoID="+pid+"&LoginName="+name;;
                ...
                <asp:Repeater ID="NewsList" OnItemDataBound="NewsList_ItemDataBound" runat="server">
                    <ItemTemplate>
                        <tr onmouseover="this.style.backgroundColor='#f5f5f5';" onmouseout="this.style.backgroundColor=''">
                            <%--<td >
                                <label>
                                    <input type="checkbox" name="cbxSelect" id="cbxSelect" value="<%#Eval("videoid")%>" />
                                </label>
                            </td>--%>
                            <td>
                                <%#Eval("videoid")%>
                            ...
                            <td>
                            <a href='http://<%#Eval("loginName") %>.topfo.com/video.htm'; target="_blank">查看</a> 
                                                                <a href='JavaScript:modifyNavigate("<%#Eval("videoid") %>","<%#Eval("loginName") %>");'>修改</a> 
                               <%-- <a href='JavaScript:DelNav("<%#Eval("videoid") %>");');' onclick="return confirm('确认要删除吗？') ">删除</a>--%>
