<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaManage.aspx.cs" Inherits="dptopfo_AreaManage" %>
<%@ Register Assembly="Tz888.Pager" Namespace="Tz888.Pager" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>区域概况列表信息</title>
...
function modifyNavigate(pid)
{
    ...
    url="AreaInsert.aspx?LoginName="+pid;
                ...
                <asp:Repeater ID="NewsList" OnItemDataBound="NewsList_ItemDataBound" runat="server">
                    <ItemTemplate>
                        <tr onmouseover="this.style.backgroundColor='#f5f5f5';" onmouseout="this.style.backgroundColor=''">
                            <%--<td >
                                <label>
                                    <input type="checkbox" name="cbxSelect" id="cbxSelect" value="<%#Eval("areaid")%>" />
                                </label>
                            </td>--%>
                            <td>
                                <%#Eval("areaid")%>
                            ...
                            <td>
                                <%#Convert.ToDateTime(Eval("createdates")).ToString("yyyy-MM-dd (hh:mm)")%>
                            </td>
                            <td>
                            <a href='http://<%#Eval("loginName") %>.topfo.com/Regionaloverview.htm'; target="_blank">查看</a> 
                                <a href='JavaScript:modifyNavigate("<%#Eval("loginName") %>");'>修改</a> 
                                <%--<a href='JavaScript:DelNav("<%#Eval("areaid") %>");');' onclick="return confirm('确认要删除吗？') ">删除</a>--%>
