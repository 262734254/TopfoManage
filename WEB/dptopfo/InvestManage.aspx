<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvestManage.aspx.cs" Inherits="dptopfo_InvestManage" %>
...
function modifyNavigate(pid)
{
    ...
    url="AddNewInvest.aspx?LoginName="+pid;
                ...
                <asp:Repeater ID="NewsList" OnItemDataBound="NewsList_ItemDataBound" runat="server">
                    <ItemTemplate>
                        <tr onmouseover="this.style.backgroundColor='#f5f5f5';" onmouseout="this.style.backgroundColor=''">
                           <%-- <td >
                                <label>
                                    <input type="checkbox" name="cbxSelect" id="cbxSelect" value="<%#Eval("Costid")%>" />
                                </label>
                            </td>--%>
                            <td>
                                <%#Eval("Costid")%>
                            ...
                            <td>
                            <a href='http://<%#Eval("loginName") %>.topfo.com/cost.htm'; target="_blank">查看</a> 
                                <a href='JavaScript:modifyNavigate("<%#Eval("loginName") %>");'>修改</a> 
                               <%-- <a href='JavaScript:DelNav("<%#Eval("Costid") %>");');' onclick="return confirm('确认要删除吗？') ">删除</a>--%>
