<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkManage.aspx.cs" Inherits="dptopfo_LinkManage" %>

<%@ Register Assembly="Tz888.Pager" Namespace="Tz888.Pager" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>联系方式列表信息</title>
...
function modifyNavigate(pid)
{
    ...
    url="AddLink.aspx?loginName="+pid;
                    ...
                    <ItemTemplate>
                        <tr onmouseover="this.style.backgroundColor='#f5f5f5';" onmouseout="this.style.backgroundColor=''">
                          <%--  <td >
                            ...
                            <td>
                            <a href='http://<%#Eval("loginName") %>.topfo.com/Contact.htm'; target="_blank">查看</a> 
                                <a href='JavaScript:modifyNavigate("<%#Eval("loginName") %>");'>修改</a> 
                              <%--  <a href='JavaScript:DelNav("<%#Eval("linkId") %>");');' onclick="return confirm('确认要删除吗？') ">删除</a>--%>
