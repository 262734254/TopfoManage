<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CapitalManage.aspx.cs" Inherits="offer_CapitalManage" %>
...
function modifyNavigate(fid,infoId)
{
    ...
    {
    var url="";
    url="CapitalModify.aspx?fid="+fid;
    window.location.href=url;
    }
    else
    {
     var url="";
    url="CapitalModify.aspx?fid="+fid+"&infoID="+infoId;
    window.location.href=url;
    }
 ...
 <a href='JavaScript:recommNavigate("<%#Eval("InfoID") %>");'><%#getStatu(Convert.ToInt32(Eval("AuditingStatus")))%></a>
    ...
    <tr>
            <td align="left" style="height: 24px" >
                生成招商首页：<asp:TextBox ID="txtIndex" runat="server" Width="247px">http://tz.topfo.com/index.aspx</asp:TextBox>&nbsp;
    ...
    <div>
     <a href="Javascript:SelectAll();">全选</a>/<a
        ...
        <asp:Button ID="btnStatic" runat="server" OnClientClick="return Fun();" CssClass="btn" OnClick="btnStatic_Click"
            Text="批量生成" />
            <input type="button" class="btn" value="资源发布" onclick="javascript:location.href='AddCapital.aspx'" />
