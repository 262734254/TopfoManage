<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddBrand.aspx.cs" Inherits="Brand_AddBrand" %>
   ...
   function CheckNull()
   {
     try
     {
          var Title=document.getElementById("<%=txtTitle.ClientID %>");
           ...
           var UrlReg =/^.*(.com|.cn|.com.cn|.org|.net)$/g;
...
<body>
    ...
    <input id="btnTest" type="button" value="sfd" style="fileter:alpha(opacity=80)" />
   <div class="title" align="center">
       ...
       <table width="100%" cellpadding="0" cellspacing="0" class="one_table">
                ...
                <tr>
                    ...
                    <td><input id="txtSort" onkeyup="value=value.replace(/[^0-9]/g,'')" runat="server" type="text" style="width: 238px; height: 20px" /></td>
                </tr>
                <tr>
