<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Modify.aspx.cs" Inherits="TradeShow_Modify" %>
...
<body>
    <form id="form1" runat="server">
        <div class="title" align="center">
            ...
            <h2><p><span><b>修改参会名单</b></span></p></h2>
        </div>
        <table width="100%" cellpadding="0" cellspacing="0" class="one_table">
            ...
            <tr>
                <td colspan="2" align="center" style="height: 24px">
                    <asp:Button runat="server" ID="BtnModify" OnClientClick="return CheckNull();"
                        CssClass="btn" Text="修改" OnClick="BtnModify_Click" />
                    &nbsp;&nbsp;
