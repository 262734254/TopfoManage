<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateNews.aspx.cs" Inherits="zx_UpdateNews" ValidateRequest="false" %>
...
<table id="tabRedirect"   border="0" cellpadding="0" cellspacing="0" class="one_table">
             ...
             <tr>
                <td style="width: 66px" ><font color="red">*</font> 资讯摘要</td>
        ...
        <tr style="display:none">
            ...
            <tr>
                <td style="width: 66px; height: 85px" >
                    <div>
                        内容分页：</div>
                </td>
                <td style="width: 357px; height: 85px">
                <div>
		...
		注：手动分页符标记为“ [NextPage] ”<br/>
           ...
           <table  border="0" cellpadding="0" cellspacing="0" class="one_table">
            <tr>
                <td style="height: 24px; width: 67px;" > 开始日期：</td>
                <td >
                    <cc1:DateTimeBox ID="txtValidateStartTime" runat="server"></cc1:DateTimeBox></td>
            </tr>
             <tr>
                <td style="width: 67px"><font color="red">*</font> 有效期：</td>
                <td >
		           ...
		           </asp:DropDownList>个月</td>
            </tr>
             <tr>
                <td style="width: 67px"><font color="red">*</font> 模版号：</td>
                <td>
                    <asp:TextBox ID="txtTemplate" runat="server">001</asp:TextBox></td>
            </tr>
               <tr>
                   <td style="width: 67px">
                 ...
                 <tr>
                   <td style="width: 67px">
                       <span style="color: #ff0000">*</span>评分：</td>
                   <td >
                 ...
                 <tr>
                   <td style="display:none; width: 67px;">
                       <span style="color: #ff0000">*</span>等级：</td>
                   
                   <td style="display:none">
                       <asp:DropDownList ID="ddlFix" runat="server">
                       </asp:DropDownList>
                       </td><%--   <tr>
                   <td>
                       &nbsp;&nbsp; 审 &nbsp; &nbsp;&nbsp; 核:</td>
                   ...
                   <input id="cbAuditing" type="checkbox" name="cbAuditing" runat="server" /><label for="cbAuditing">直接审核通过</label>
                                ...
                                <tr>
                   <td style="display:none; width: 67px;">
                       <span style="color: #ff0000">*</span>浏览量：</td>
               ...
               <tr>
						<td style="width: 67px"><span class="hong">*</span>审核状态</td>
						<td align="left">
