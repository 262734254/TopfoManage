<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderManage.aspx.cs" Inherits="Order_OrderManage" %>
...
{
    var url="";
    url="ModifyOrder.aspx?OrderNo="+pid;
                    ...
                    <ItemTemplate>
                        <tr onmouseover="this.style.backgroundColor='#f5f5f5';" onmouseout="this.style.backgroundColor=''">
                            <td style="width: 100px">
                                <label>
                                    <input type="checkbox" name="cbxSelect" id="cbxSelect" value="<%#Eval("orderNo")%>" />
                                </label>
                            </td>
                            <td align="center">
                               <%#Eval("orderNo")%>
                            ...
                            <td align="center">
                               <%#getstate(Convert.ToInt32(Eval("state").ToString()),0)%>
                            </td>
                            <td align="center">
                               <%#getstate(Convert.ToInt32(Eval("paySate").ToString()),1)%>
                            </td>
                            <td style="width: 100px" align="center">
                                <a href='JavaScript:modifyNavigate("<%#Eval("orderNo") %>");'>修改</a> 
                                <a href='JavaScript:DelNav("<%#Eval("orderNo") %>");');' onclick="return confirm('确认要删除吗？') ">删除</a>
