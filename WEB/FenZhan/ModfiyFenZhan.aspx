<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModfiyFenZhan.aspx.cs" Inherits="fenzhan_ModfiyFenZhan" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="one_table">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropProvince1" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center" style="height: 24px">
                    <asp:Button runat="server" ID="BtnModfiy" OnClientClick="return ValidDate();" CssClass="btn" Text="修改" OnClick="BtnModfiy_Click" />
                </td>
            </tr>
        </table>
    </form>
