  <%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPicture.aspx.cs" Inherits="Picture_AddPicture" %>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="one_table">
            ...
            <tr>
                <td colspan="2" align="center" style="height: 24px">
                    <asp:Button runat="server" ID="BtnSvae" OnClick="BtnSave_Click" OnClientClick="return CheckNull();"
