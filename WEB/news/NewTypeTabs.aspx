<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewTypeTabs.aspx.cs" Inherits="news_NewTypeTabs" %>
...
<body>
    ...
    <tr><td>是否启用：</td><td >
        ...
        <asp:RadioButtonList ID="radiotuijian" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal">
            ...
            <asp:ListItem Selected="True" Value="1">拓富中心</asp:ListItem>
        </asp:RadioButtonList></td></tr>
