<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddChannel.aspx.cs" Inherits="Link_AddChannel" %>
...
<body>
   ...
   <div class="title" align="center">
             <h2><p><span><b><a href="ChannelManage.aspx">频道管理</a></b></span></p></h2>
             <h2><p><span><b>添加频道</b></span></p></h2>
   </div>
       <table width="100%" cellpadding="0" cellspacing="0" class="one_table">
                ...
                <td colspan="2" align="center" style="height: 24px">
                    ...
                    &nbsp;&nbsp;<input type="button" class="btn" onclick="location.href='ChannelManage.aspx';" value="返回" />
                </td>
                </tr>
            </table>
