<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkTypeManage.aspx.cs" Inherits="Link_LinkTypeManage" %>
...
<head id="Head1" runat="server">
    <title>企业名片管理</title>
        ...
        <script language="javascript" type="text/javascript">
          ...
          function Modfiy(id)
          {
             var url="LinkTypeExamine.aspx?TypeId="+id;
...
<body>
    ...
    <div class="mainconbox">
       ...
       <div class="title" align="center"><h2><p><span><b>友情链接类型管理</b></span></p></h2></div>
             <table border="0" cellpadding="0" cellspacing="0" align="center" class="one_table" >
                <tr>
                    <td align="center" >
                        类别名称：
                        <input id="txtLinkType"   type="text"  runat="server" />
                        </td>
                        <td align="center" >
                        审核状态：
                        ...
                        <td>
                        <asp:Button runat="server" ID="Search" CssClass="btn" Text="确定" OnClick="Search_Click" />
                         </td>
                </tr>
            </table>
        <div class=" cshibiank">
          ...
          <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="one_table"  >
                <tr >
                  <th width="6%" align="center" class="tabtitle" style="height: 29px">
                    <a href="Javascript:SelectAll();">全</a>|<a href="Javascript:ReSelect();">反</a> </th>
                            ...
                            <th align="center" width="14%" class="tabtitle" >类别名称</th>
                            <th align="center" width="12%" class="tabtitle" >审核状态</th>
                            <th align="center" width="16%" class="tabtitle" >备注</th>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                     <ItemTemplate>
                         ...
                         <td align="center" >
                            <label>
                                <input type="checkbox" name="cbxSelect" id="cbxSelect" value="<%#Eval("LinkId") %>" />
                            </label>
                        </td>                      
                         <td align="center">
                        ...
                        <td  align="center">
                            <a href='JavaScript:Modfiy(<%#Eval("LinkId") %>)'>审核</a>&nbsp &nbsp
                        </td>               
    ...
    <div>
           <input type="button" value="添加类别" class="btn" onclick="window.location.href='AddLinkType.aspx';" />
