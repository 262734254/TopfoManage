<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkTypeExamine.aspx.cs" Inherits="Link_LinkTypeExamine" %>
...
<body>
    <form id="form1" runat="server">
        <div class="title" align="center">
            <h2>
                <p>
                    <span><b><a href="LinkTypeManage.aspx">友情链接类型管理</a></b></span></p>
            </h2>
            <h2>
                <p>
                    <span><b>审核友情链接类别</b></span></p>
            </h2>
        </div>
