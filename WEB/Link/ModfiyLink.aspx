<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModfiyLink.aspx.cs" Inherits="Link_ModfiyLink" %>
...
<script language="javascript" type="text/jscript">
   ...
   function CheckNull()
   {
       ...
       if(LinkType.options[DropLinkType.selectedIndex].value=="0")
       {
          alert("链接类别不能为空!");
          LinkType.focus();
          return false;
...
<body>
   ...
   <div class="title" align="center">
             <h2><p><span><b><a href="LinkManage.aspx">友情连接管理</a></b></span></p></h2>
             <h2><p><span><b>添加友情连接</b></span></p></h2>
   </div>
       <table width="100%" cellpadding="0" cellspacing="0" class="one_table">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropChannel" Width="150" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="f_td">
                    ...
                    <td>
                        <asp:DropDownList ID="DropLinkType" Width="150" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="f_td">
                ...
                <tr>
                 <td align="right" class="f_td">序列号：</td>
                    <td>
                        <input id="txtSort" runat="server" type="text" onkeyup="value=value.replace(/[^0-9]/g,'')" style="width: 238px; height: 20px" />
                    </td>
                </tr>
                <tr>
                    <td align="right" class="f_td">Logo：</td>
                    <td>
                        <asp:FileUpload runat="server" ID="File1" />&nbsp;&nbsp;
                        <asp:Button ID="UpLoadImg" runat="server" Text="上传" OnClientClick="return CheckFile();" CssClass="btn" OnClick="UploadImg_Click" />
                        <br />
                ...
                <td colspan="2" align="center" style="height: 24px">
                    ...
                    &nbsp;&nbsp;<input type="button" class="btn" onclick="location.href='LinkManage.aspx';" value="返回" />
                </td>
                </tr>
            </table>
