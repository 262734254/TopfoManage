<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RoleControl.ascx.cs" Inherits="UserControl_RoleControl" %>
 <STYLE type="text/css">
...
<span class="hui">最多可添加
    <%=this.MaxCount %>
    种角色。如选择有误，选择对应角色，点击 “删除”按钮即可。</span> <span id="spSelectIndustry"></span>
