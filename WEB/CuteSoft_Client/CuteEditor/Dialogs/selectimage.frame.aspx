...
<html>
	<head>
		...
		var OxOea67=["disabled","srcElement","[[Disabled]]","[[SpecifyNewFolderName]]","","value","hiddenActionData","[[CopyMoveto]]","/","[[AreyouSureDelete]]","parentNode","text","isdir",".","[[SpecifyNewFileName]]","hiddenAction","rename","path","True","False",":","cancelBubble","backgroundColor","style","#eeeeee","tagName","INPUT","changedir","hiddenFile","url","TargetUrl"]; function CreateDir_click(){if(event[OxOea67[0x1]][OxOea67[0x0]]){ alert(OxOea67[0x2]) ;return false;} ;var Ox2fb=prompt(OxOea67[0x3],OxOea67[0x4]);if(Ox2fb){ document.getElementById(OxOea67[0x6])[OxOea67[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Move_click(){if(event[OxOea67[0x1]][OxOea67[0x0]]){ alert(OxOea67[0x2]) ;return false;} ;var Ox2fb=prompt(OxOea67[0x7],OxOea67[0x8]);if(Ox2fb){ document.getElementById(OxOea67[0x6])[OxOea67[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Copy_click(){if(event[OxOea67[0x1]][OxOea67[0x0]]){ alert(OxOea67[0x2]) ;return false;} ;var Ox2fb=prompt(OxOea67[0x7],OxOea67[0x8]);if(Ox2fb){ document.getElementById(OxOea67[0x6])[OxOea67[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Delete_click(){if(event[OxOea67[0x1]][OxOea67[0x0]]){ alert(OxOea67[0x2]) ;return false;} ;return confirm(OxOea67[0x9]);}  ; function EditImg_click(Oxb9){if(Oxb9[OxOea67[0x0]]){ alert(OxOea67[0x2]) ;return false;} ; row=Oxb9[OxOea67[0xa]][OxOea67[0xa]] ;var Ox550=row[OxOea67[0xb]];var name;if(row[OxOea67[0xc]]){ name=prompt(OxOea67[0x3],Ox550) ;} else {var i=Ox550.lastIndexOf(OxOea67[0xd]);var Ox551=Ox550.substr(i);var Ox20=Ox550.substr(0x0,Ox550.lastIndexOf(OxOea67[0xd])); name=prompt(OxOea67[0xe],Ox20) ;if(name){ name=name+Ox551 ;} ;} ;if(name&&(name!=row[OxOea67[0xb]])){ document.getElementById(OxOea67[0xf])[OxOea67[0x5]]=OxOea67[0x10] ; document.getElementById(OxOea67[0x6])[OxOea67[0x5]]=(row[OxOea67[0xc]]?OxOea67[0x12]:OxOea67[0x13])+OxOea67[0x14]+row[OxOea67[0x11]]+OxOea67[0x14]+name ; postback() ;} ; event[OxOea67[0x15]]=true ;}  ; function row_over(Oxc3){ Oxc3[OxOea67[0x17]][OxOea67[0x16]]=OxOea67[0x18] ;}  ; function row_out(Oxc3){ Oxc3[OxOea67[0x17]][OxOea67[0x16]]=OxOea67[0x4] ;}  ; function row_click(Oxc3){if(Oxc3[OxOea67[0xc]]){if(event[OxOea67[0x1]][OxOea67[0x19]]==OxOea67[0x1a]){return ;} ; document.getElementById(OxOea67[0xf])[OxOea67[0x5]]=OxOea67[0x1b] ; document.getElementById(OxOea67[0x6])[OxOea67[0x5]]=Oxc3.getAttribute(OxOea67[0x11]) ; postback() ;} else {var Ox4f4=Oxc3.getAttribute(OxOea67[0x11]); document.getElementById(OxOea67[0x1c])[OxOea67[0x5]]=Ox4f4 ;var Oxba=Oxc3.getAttribute(OxOea67[0x1d]); document.getElementById(OxOea67[0x1e])[OxOea67[0x5]]=Oxba ; do_preview() ;} ;}  ; function postback(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style>
		.row { HEIGHT: 22px }
	...
	<body bottomMargin="0" topMargin="10" leftmargin="3" marginwidth="0" marginheight="0">
		<form runat="server" enctype="multipart/form-data" id="Form1">
			<!-- start hidden -->
			<script>
        var OxO50b5=["onload","value","hiddenAlert","","hiddenAction","hiddenActionData"]; window[OxO50b5[0x0]]=reset_hiddens ; function reset_hiddens(){if(document.getElementById(OxO50b5[0x2])[OxO50b5[0x1]]){ alert(document.getElementById(OxO50b5[0x2]).value) ;} ; document.getElementById(OxO50b5[0x2])[OxO50b5[0x1]]=OxO50b5[0x3] ; document.getElementById(OxO50b5[0x4])[OxO50b5[0x1]]=OxO50b5[0x3] ; document.getElementById(OxO50b5[0x5])[OxO50b5[0x1]]=OxO50b5[0x3] ;}  ;
			</script>
	...
	<script>
			var OxOad5f=["value","TargetUrl","","src",".aspx","display","style","img_AutoThumbnail","none","img_ImageEditor","returnValue","zoom","height","width","Width","Height","IMG","length","[[SelectImagetoThumbnail]]","[[_CuteEditorResource_]]","\x26p=","dialogWidth:310px;dialogHeight:200px;help:no;scroll:no;status:no;resizable:0;","hiddenAction","refresh","[[SelectImagetoEdit]]","dialogWidth:676px;dialogHeight:500px;help:no;scroll:no;status:no;resizable:0;"]; do_preview() ; function do_preview(){var Oxba=document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]];if(Oxba==OxOad5f[0x2]){return ;} ;var img2=GetPreviewedImage(); img2[OxOad5f[0x3]]=Oxba ; Oxba=Oxba.toLowerCase() ;if(Oxba.indexOf(OxOad5f[0x4])!=-0x1){ document.getElementById(OxOad5f[0x7])[OxOad5f[0x6]][OxOad5f[0x5]]=OxOad5f[0x8] ; document.getElementById(OxOad5f[0x9])[OxOad5f[0x6]][OxOad5f[0x5]]=OxOad5f[0x8] ;} ;}  ; function do_insert(){ top[OxOad5f[0xa]]=document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]] ; top.close() ;}  ; function do_cancel(){ top[OxOad5f[0xa]]=null ; top.close() ;}  ; function Zoom_In(){if(divpreview[OxOad5f[0x6]][OxOad5f[0xb]]!=0x0){ divpreview[OxOad5f[0x6]][OxOad5f[0xb]]*=1.2 ;} else { divpreview[OxOad5f[0x6]][OxOad5f[0xb]]=1.2 ;} ;}  ; function Zoom_Out(){if(divpreview[OxOad5f[0x6]][OxOad5f[0xb]]!=0x0){ divpreview[OxOad5f[0x6]][OxOad5f[0xb]]*=0.8 ;} else { divpreview[OxOad5f[0x6]][OxOad5f[0xb]]=0.8 ;} ;}  ; function BestFit(){var Oxb9=GetPreviewedImage();if(!Oxb9){return ;} ;var Ox2e2=0x118;var Ox81=0x122; divpreview[OxOad5f[0x6]][OxOad5f[0xb]]=0x1/Math.max(Oxb9[OxOad5f[0xd]]/Ox81,Oxb9[OxOad5f[0xc]]/Ox2e2) ;}  ; function Actualsize(){try{var Oxb9= new Image(); Oxb9[OxOad5f[0x3]]=document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]] ;if(Oxb9[OxOad5f[0xd]]){ document.getElementById(OxOad5f[0xe])[OxOad5f[0x0]]=Oxb9[OxOad5f[0xd]] ;} ;if(Oxb9[OxOad5f[0xc]]){ document.getElementById(OxOad5f[0xf])[OxOad5f[0x0]]=Oxb9[OxOad5f[0xc]] ;} ;} catch(er){} ; do_preview() ; divpreview[OxOad5f[0x6]][OxOad5f[0xb]]=0x1 ;}  ; function GetPreviewedImage(){var Ox355=divpreview.getElementsByTagName(OxOad5f[0x10]);if(Ox355&&(Ox355[OxOad5f[0x11]]>0x0)){return Ox355.item(0x0);} else {return null;} ;}  ; function AutoThumbnail(){if(document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]]==OxOad5f[0x2]){ alert(OxOad5f[0x12]) ;return false;} ;var src=document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]];var Ox2f=OxOad5f[0x13];var Ox422=showModalDialog('Thumbnail.aspx?<%= QUERY_STRING %>&f='+src+OxOad5f[0x14]+Ox2f+OxOad5f[0x2],src,OxOad5f[0x15]); document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]]=Ox422 ; Actualsize() ; document.getElementById(OxOad5f[0x16])[OxOad5f[0x0]]=OxOad5f[0x17] ; postback() ;}  ; function ImageEditor(){if(document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]]==OxOad5f[0x2]){ alert(OxOad5f[0x18]) ;return false;} ;var Oxb9= new Image(); Oxb9[OxOad5f[0x3]]=document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]] ;var src=document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]];var Ox2f=OxOad5f[0x13];var arr=showModalDialog('../ImageEditor/ImageEditor.aspx?<%= QUERY_STRING %>&f='+src+OxOad5f[0x14]+Ox2f+OxOad5f[0x2],Oxb9,OxOad5f[0x19]); document.getElementById(OxOad5f[0x1])[OxOad5f[0x0]]=src ; do_preview() ;}  ;	
	</script>
</html>
