...
<html>
	<head>
		...
		var OxO6a02=["dialogArguments","name","returnValue","value","anchor1"];var oControl=top[OxO6a02[0x0]]; alert( typeof (oControl)) ;var V_anchor_name=oControl.getAttribute(OxO6a02[0x1]); function insert_link(){ oControl.setAttribute(OxO6a02[0x1],anchor_name.value) ; top[OxO6a02[0x2]]=true ; top.close() ;}  ; function Init(){ anchor_name[OxO6a02[0x3]]=V_anchor_name||OxO6a02[0x4] ;}  ;
		</script>
		<style>
