...
<HTML>
	<head runat=server ID="Head1" NAME="Head1">
		...
		<script language="javascript">
			var OxOef74=["dialogArguments","ig","","\x3C/?[^\x3E]*\x3E","\x3C\x5C?xml[^\x3E]*\x3E","\x3C/?[a-z]+:[^\x3E]*\x3E","(\x3C[^\x3E]+) class=[^ |^\x3E]*([^\x3E]*\x3E)","$1 $2","(\x3C[^\x3E]+) style=\x22[^\x22]*\x22([^\x3E]*\x3E)","\x3Cspan[^\x3E]*\x3E\x3C/span[^\x3E]*\x3E","\x3Cspan\x3E\x3Cspan\x3E","\x3Cspan\x3E","\x3C/span\x3E\x3C/span\x3E","\x3C/span\x3E","[ ]*\x3E","\x3E","\x3C/?font[^\x3E]*\x3E","\x3C/?span[^\x3E]*\x3E","span","font","css","word","allhtml"]; window.resizeTo(0xf0,0x145) ;var editor=top[OxOef74[0x0]]; function execRE(Ox180,Ox4da,Ox4db){ oReg= new RegExp(Ox180,OxOef74[0x1]) ; r=Ox4db.replace(oReg,Ox4da) ;return r;}  ; function getContent(){if(editor.getHTML()){return editor.getHTML();} else {return OxOef74[0x2];} ;}  ; function setContent(Ox4db){try{ editor.setHTML(Ox4db) ;} catch(e){} ;}  ; function codeCleaner(Ox318){var Ox4db=getContent();switch(Ox318){case OxOef74[0x16]: Ox4db=execRE(OxOef74[0x3],OxOef74[0x2],Ox4db) ;break ;case OxOef74[0x15]: Ox4db=execRE(OxOef74[0x4],OxOef74[0x2],Ox4db) ; Ox4db=execRE(OxOef74[0x5],OxOef74[0x2],Ox4db) ; Ox4db=execRE(OxOef74[0x6],OxOef74[0x7],Ox4db) ; Ox4db=execRE(OxOef74[0x8],OxOef74[0x7],Ox4db) ; Ox4db=execRE(OxOef74[0x9],OxOef74[0x2],Ox4db) ; Ox4db=execRE(OxOef74[0xa],OxOef74[0xb],Ox4db) ; Ox4db=execRE(OxOef74[0xc],OxOef74[0xd],Ox4db) ; Ox4db=execRE(OxOef74[0xe],OxOef74[0xf],Ox4db) ;break ;case OxOef74[0x14]: Ox4db=execRE(OxOef74[0x6],OxOef74[0x7],Ox4db) ; Ox4db=execRE(OxOef74[0x8],OxOef74[0x7],Ox4db) ;break ;case OxOef74[0x13]: Ox4db=execRE(OxOef74[0x10],OxOef74[0x2],Ox4db) ;break ;case OxOef74[0x12]: Ox4db=execRE(OxOef74[0x11],OxOef74[0x2],Ox4db) ;break ;;;;;;} ; setContent(Ox4db) ;}  ;
		</script>
		<style type=text/css>
			.codebutton
			{
