...
<HTML>
	<head>
		...
		<script>
		var OxOc61a=["dialogArguments","keyboard_area","length","value"];var editor=top[OxOc61a[0x0]]; function do_insert(){var Ox6b2=document.getElementById(OxOc61a[0x1]);if(Ox6b2[OxOc61a[0x3]][OxOc61a[0x2]]>0x0){ editor.PasteHTML(Ox6b2.value) ;} ;}  ; function do_cancel(){ top.close() ;}  ;
		</script>
	</HEAD>
		<body>
