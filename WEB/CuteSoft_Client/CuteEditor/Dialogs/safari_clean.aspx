...
<HTML>
	<head runat=server ID="Head1" NAME="Head1">
		...
		<script language="javascript">
			var OxO662e=["availWidth","availHeight","dialogArguments","opener","ig","","\x3C/?[^\x3E]*\x3E","\x3C\x5C?xml[^\x3E]*\x3E","\x3C/?[a-z]+:[^\x3E]*\x3E","(\x3C[^\x3E]+) class=[^ |^\x3E]*([^\x3E]*\x3E)","$1 $2","(\x3C[^\x3E]+) style=\x22[^\x22]*\x22([^\x3E]*\x3E)","\x3Cspan[^\x3E]*\x3E\x3C/span[^\x3E]*\x3E","\x3Cspan\x3E\x3Cspan\x3E","\x3Cspan\x3E","\x3C/span\x3E\x3C/span\x3E","\x3C/span\x3E","[ ]*\x3E","\x3E","\x3C/?font[^\x3E]*\x3E","\x3C/?span[^\x3E]*\x3E","span","font","css","word","allhtml"]; window.resizeTo(0xf0,0xe1) ; window.focus() ; window.moveTo((screen[OxO662e[0x0]]-0x258)/0x2,(screen[OxO662e[0x1]]-0x190)/0x2) ;var editor=window[OxO662e[0x3]][OxO662e[0x2]]; function execRE(Ox180,Ox4da,Ox4db){ oReg= new RegExp(Ox180,OxO662e[0x4]) ;return Ox4db.replace(oReg,Ox4da);}  ; function getContent(){if(editor.getHTML()){return editor.getHTML();} else {return OxO662e[0x5];} ;}  ; function setContent(Ox4db){try{ editor.setHTML(Ox4db) ;} catch(e){} ;}  ; function codeCleaner(Ox318){var Ox4db=getContent();switch(Ox318){case OxO662e[0x19]: Ox4db=execRE(OxO662e[0x6],OxO662e[0x5],Ox4db) ;break ;case OxO662e[0x18]: Ox4db=execRE(OxO662e[0x7],OxO662e[0x5],Ox4db) ; Ox4db=execRE(OxO662e[0x8],OxO662e[0x5],Ox4db) ; Ox4db=execRE(OxO662e[0x9],OxO662e[0xa],Ox4db) ; Ox4db=execRE(OxO662e[0xb],OxO662e[0xa],Ox4db) ; Ox4db=execRE(OxO662e[0xc],OxO662e[0x5],Ox4db) ; Ox4db=execRE(OxO662e[0xd],OxO662e[0xe],Ox4db) ; Ox4db=execRE(OxO662e[0xf],OxO662e[0x10],Ox4db) ; Ox4db=execRE(OxO662e[0x11],OxO662e[0x12],Ox4db) ;break ;case OxO662e[0x17]: Ox4db=execRE(OxO662e[0x9],OxO662e[0xa],Ox4db) ; Ox4db=execRE(OxO662e[0xb],OxO662e[0xa],Ox4db) ;break ;case OxO662e[0x16]: Ox4db=execRE(OxO662e[0x13],OxO662e[0x5],Ox4db) ;break ;case OxO662e[0x15]: Ox4db=execRE(OxO662e[0x14],OxO662e[0x5],Ox4db) ;break ;;;;;;} ; setContent(Ox4db) ;}  ;
		</script>
		<style type=text/css>
			.codebutton
			{
