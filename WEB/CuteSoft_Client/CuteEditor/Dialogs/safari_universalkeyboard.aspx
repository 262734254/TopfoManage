...
<HTML>
	<head>
		...
		<script>
		var OxOb4c0=["availWidth","availHeight","dialogArguments","opener","editor","editdoc","keyboard_area","length","value","Delete",""]; window.focus() ; window.moveTo((screen[OxOb4c0[0x0]]-0x258)/0x2,(screen[OxOb4c0[0x1]]-0x190)/0x2) ;var obj=window[OxOb4c0[0x3]][OxOb4c0[0x2]];var editor=obj[OxOb4c0[0x4]];var editdoc=obj[OxOb4c0[0x5]]; function do_insert(){var Ox6b2=document.getElementById(OxOb4c0[0x6]);if(Ox6b2[OxOb4c0[0x8]][OxOb4c0[0x7]]>0x0){ editdoc.execCommand(OxOb4c0[0x9],false,OxOb4c0[0xa]) ; editor.PasteHTML(Ox6b2.value) ; top.close() ;} ;}  ; function do_cancel(){ top.close() ;}  ;
		</script>
	</HEAD>
		<body>
