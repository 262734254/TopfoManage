...
<HTML>
	<HEAD>
		...
		var OxOb30e=["disabled","srcElement","[[Disabled]]","[[SpecifyNewFolderName]]","","value","hiddenActionData","[[CopyMoveto]]","/","[[AreyouSureDelete]]","parentNode","text","isdir",".","[[SpecifyNewFileName]]","hiddenAction","rename","path","True","False",":","cancelBubble","backgroundColor","style","#eeeeee","tagName","INPUT","changedir","hiddenFile","url","TargetUrl"]; function CreateDir_click(){if(event[OxOb30e[0x1]][OxOb30e[0x0]]){ alert(OxOb30e[0x2]) ;return false;} ;var Ox2fb=prompt(OxOb30e[0x3],OxOb30e[0x4]);if(Ox2fb){ document.getElementById(OxOb30e[0x6])[OxOb30e[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Move_click(){if(event[OxOb30e[0x1]][OxOb30e[0x0]]){ alert(OxOb30e[0x2]) ;return false;} ;var Ox2fb=prompt(OxOb30e[0x7],OxOb30e[0x8]);if(Ox2fb){ document.getElementById(OxOb30e[0x6])[OxOb30e[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Copy_click(){if(event[OxOb30e[0x1]][OxOb30e[0x0]]){ alert(OxOb30e[0x2]) ;return false;} ;var Ox2fb=prompt(OxOb30e[0x7],OxOb30e[0x8]);if(Ox2fb){ document.getElementById(OxOb30e[0x6])[OxOb30e[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Delete_click(){if(event[OxOb30e[0x1]][OxOb30e[0x0]]){ alert(OxOb30e[0x2]) ;return false;} ;return confirm(OxOb30e[0x9]);}  ; function EditImg_click(Oxb9){if(Oxb9[OxOb30e[0x0]]){ alert(OxOb30e[0x2]) ;return false;} ; row=Oxb9[OxOb30e[0xa]][OxOb30e[0xa]] ;var Ox550=row[OxOb30e[0xb]];var name;if(row[OxOb30e[0xc]]){ name=prompt(OxOb30e[0x3],Ox550) ;} else {var i=Ox550.lastIndexOf(OxOb30e[0xd]);var Ox551=Ox550.substr(i);var Ox20=Ox550.substr(0x0,Ox550.lastIndexOf(OxOb30e[0xd])); name=prompt(OxOb30e[0xe],Ox20) ;if(name){ name=name+Ox551 ;} ;} ;if(name&&name!=row[OxOb30e[0xb]]){ document.getElementById(OxOb30e[0xf])[OxOb30e[0x5]]=OxOb30e[0x10] ; document.getElementById(OxOb30e[0x6])[OxOb30e[0x5]]=(row[OxOb30e[0xc]]?OxOb30e[0x12]:OxOb30e[0x13])+OxOb30e[0x14]+row[OxOb30e[0x11]]+OxOb30e[0x14]+name ; postback() ;} ; event[OxOb30e[0x15]]=true ;}  ; function row_over(Oxc3){ Oxc3[OxOb30e[0x17]][OxOb30e[0x16]]=OxOb30e[0x18] ;}  ; function row_out(Oxc3){ Oxc3[OxOb30e[0x17]][OxOb30e[0x16]]=OxOb30e[0x4] ;}  ; function row_click(Oxc3){if(Oxc3[OxOb30e[0xc]]){if(event[OxOb30e[0x1]][OxOb30e[0x19]]==OxOb30e[0x1a]){return ;} ; document.getElementById(OxOb30e[0xf])[OxOb30e[0x5]]=OxOb30e[0x1b] ; document.getElementById(OxOb30e[0x6])[OxOb30e[0x5]]=Oxc3.getAttribute(OxOb30e[0x11]) ; postback() ;} else {var Ox4f4=Oxc3.getAttribute(OxOb30e[0x11]); document.getElementById(OxOb30e[0x1c])[OxOb30e[0x5]]=Ox4f4 ;var Oxba=Oxc3.getAttribute(OxOb30e[0x1d]); document.getElementById(OxOb30e[0x1e])[OxOb30e[0x5]]=Oxba ; do_preview() ;} ;}  ; function postback(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style>
		.row { HEIGHT: 22px }
	...
	<body bottomMargin="0" topMargin="10" leftmargin="3" marginwidth="0" marginheight="0">
		<form runat="server" enctype="multipart/form-data" id="Form1">
			<!-- start hidden -->
			<script>
        var OxOeead=["onload","value","hiddenAlert","","hiddenAction","hiddenActionData"]; window[OxOeead[0x0]]=reset_hiddens ; function reset_hiddens(){if(document.getElementById(OxOeead[0x2])[OxOeead[0x1]]){ alert(document.getElementById(OxOeead[0x2]).value) ;} ; document.getElementById(OxOeead[0x2])[OxOeead[0x1]]=OxOeead[0x3] ; document.getElementById(OxOeead[0x4])[OxOeead[0x1]]=OxOeead[0x3] ; document.getElementById(OxOeead[0x5])[OxOeead[0x1]]=OxOeead[0x3] ;}  ;
			</script>
    ...
    protected int GetUsedSpaceBarWidth()
    {
      ...
      return w;      
		...
		<script>
			...
			var OxO6065=["dialogArguments","TargetUrl","sel_target","inp_color","inc_class","inp_title","inp_color_preview","inp_id","inp_access","inp_index","frameloaded","color","style","value","backgroundColor","className","title","target","tabIndex","accessKey","href_cetemp","length","href","","id","innerHTML",".","\x3CIMG src=\x27","\x27\x3E","\x3Cembed src=\x22","\x22 quality=\x22high\x22 width=\x2290%\x22 height=\x2290%\x22 type=\x22application/x-shockwave-flash\x22 pluginspage=\x22http://www.macromedia.com/go/getflashplayer\x22\x3E\x3C/embed\x3E\x0A","\x3Cembed name=\x22MediaPlayer1\x22 src=\x22","\x22 autostart=-1 showcontrols=-1  type=\x22application/x-mplayer2\x22 width=\x22240\x22 height=\x22200\x22 pluginspage=\x22http://www.microsoft.com/Windows/MediaPlayer\x22 \x3E\x3C/embed\x3E\x0A",".mpeg",".mp3",".mpg",".avi",".swf",".bmp",".png",".gif",".jpg",".jpeg","\x3Cp\x3E\x26nbsp;\x3C/p\x3E","\x3Cp\x3E\x26#160;\x3C/p\x3E","\x3Cp\x3E\x3C/p\x3E","\x3Cdiv\x3E\x26#160;\x3C/div\x3E","\x3Cdiv\x3E\x26nbsp;\x3C/div\x3E","\x3Cdiv\x3E\x3C/div\x3E","name","link","returnValue","zoom"];var element=top[OxO6065[0x0]];var TargetUrl=document.getElementById(OxO6065[0x1]);var sel_target=document.getElementById(OxO6065[0x2]);var inp_color=document.getElementById(OxO6065[0x3]);var inc_class=document.getElementById(OxO6065[0x4]);var inp_title=document.getElementById(OxO6065[0x5]);var inp_color_preview=document.getElementById(OxO6065[0x6]);var inp_id=document.getElementById(OxO6065[0x7]);var inp_access=document.getElementById(OxO6065[0x8]);var inp_index=document.getElementById(OxO6065[0x9]);if(!top[OxO6065[0xa]]){ top[OxO6065[0xa]]=true ;if(element[OxO6065[0xc]][OxO6065[0xb]]){ inp_color[OxO6065[0xd]]=element[OxO6065[0xc]][OxO6065[0xb]] ; inp_color[OxO6065[0xc]][OxO6065[0xe]]=inp_color[OxO6065[0xd]] ; inp_color_preview[OxO6065[0xc]][OxO6065[0xe]]=inp_color[OxO6065[0xd]] ;} ;if(element[OxO6065[0xf]]){ inc_class[OxO6065[0xd]]=element[OxO6065[0xf]] ;} ;if(element[OxO6065[0x10]]){ inp_title[OxO6065[0xd]]=element[OxO6065[0x10]] ;} ;if(element[OxO6065[0x11]]){ sel_target[OxO6065[0xd]]=element[OxO6065[0x11]] ;} ;if(element[OxO6065[0x12]]){ inp_index[OxO6065[0xd]]=element[OxO6065[0x12]] ;} ;if(element[OxO6065[0x13]]){ inp_access[OxO6065[0xd]]=element[OxO6065[0x13]] ;} ;var src=element.getAttribute(OxO6065[0x14]);if(!src||src[OxO6065[0x15]]==0x0){ src=element.getAttribute(OxO6065[0x16],0x2)+OxO6065[0x17] ;} ; TargetUrl[OxO6065[0xd]]=src ; inp_id[OxO6065[0xd]]=element[OxO6065[0x18]] ;} ; do_preview() ; function do_preview(){ divpreview[OxO6065[0x19]]=OxO6065[0x17] ;var Oxba=TargetUrl[OxO6065[0xd]];if(Oxba==OxO6065[0x17]){return ;} ;var Ox551=Oxba.substring(Oxba.lastIndexOf(OxO6065[0x1a])).toLowerCase();switch(Ox551){case OxO6065[0x2a]:case OxO6065[0x29]:case OxO6065[0x28]:case OxO6065[0x27]:case OxO6065[0x26]: divpreview[OxO6065[0x19]]=OxO6065[0x1b]+Oxba+OxO6065[0x1c] ;break ;case OxO6065[0x25]:var Ox563=OxO6065[0x1d]+Oxba+OxO6065[0x1e]; divpreview[OxO6065[0x19]]=Ox563 ;break ;case OxO6065[0x24]:case OxO6065[0x23]:case OxO6065[0x22]:case OxO6065[0x21]:var Oxbd=OxO6065[0x1f]+Oxba+OxO6065[0x20]; divpreview[OxO6065[0x19]]=Oxbd ;break ;;;;;;;;;;;} ;}  ; function do_insert(){ element[OxO6065[0xf]]=inc_class[OxO6065[0xd]] ; element[OxO6065[0x11]]=sel_target[OxO6065[0xd]] ; element[OxO6065[0x10]]=inp_title[OxO6065[0xd]] ; element[OxO6065[0x16]]=TargetUrl[OxO6065[0xd]] ; element.setAttribute(OxO6065[0x14],TargetUrl.value) ; element[OxO6065[0x12]]=inp_index[OxO6065[0xd]] ; element[OxO6065[0x13]]=inp_access[OxO6065[0xd]] ; element[OxO6065[0x18]]=inp_id[OxO6065[0xd]] ;if(element[OxO6065[0x10]]==OxO6065[0x17]){ element.removeAttribute(OxO6065[0x10]) ;} ;if(element[OxO6065[0x11]]==OxO6065[0x17]){ element.removeAttribute(OxO6065[0x11]) ;} ;if(element[OxO6065[0xf]]==OxO6065[0x17]){ element.removeAttribute(OxO6065[0xf]) ;} ;if(element[OxO6065[0x12]]==OxO6065[0x17]){ element.removeAttribute(OxO6065[0x12]) ;} ;if(element[OxO6065[0x13]]==OxO6065[0x17]){ element.removeAttribute(OxO6065[0x13]) ;} ;try{ element[OxO6065[0xc]][OxO6065[0xb]]=inp_color[OxO6065[0xd]] ;} catch(er){ element[OxO6065[0xc]][OxO6065[0xb]]=OxO6065[0x17] ;} ;var Oxaf=element[OxO6065[0x19]];switch(Oxaf.toLowerCase()){case OxO6065[0x30]:case OxO6065[0x2f]:case OxO6065[0x2e]:case OxO6065[0x2d]:case OxO6065[0x2c]:case OxO6065[0x2b]: element[OxO6065[0x19]]=OxO6065[0x17] ;break ;default:break ;;;;;;;;} ;if(element[OxO6065[0x19]]==OxO6065[0x17]){ element[OxO6065[0x19]]=element[OxO6065[0x10]]||element[OxO6065[0x16]]||element[OxO6065[0x31]]||OxO6065[0x32] ;} ; top[OxO6065[0x33]]=element ; top.close() ;}  ; function do_cancel(){ top[OxO6065[0x33]]=null ; top.close() ;}  ; function Zoom_In(){if(divpreview[OxO6065[0xc]][OxO6065[0x34]]!=0x0){ divpreview[OxO6065[0xc]][OxO6065[0x34]]*=1.2 ;} else { divpreview[OxO6065[0xc]][OxO6065[0x34]]=1.2 ;} ;}  ; function Zoom_Out(){if(divpreview[OxO6065[0xc]][OxO6065[0x34]]!=0x0){ divpreview[OxO6065[0xc]][OxO6065[0x34]]*=0.8 ;} else { divpreview[OxO6065[0xc]][OxO6065[0x34]]=0.8 ;} ;}  ; function Actualsize(){ divpreview[OxO6065[0xc]][OxO6065[0x34]]=0x1 ;}  ;
		</script>
	</body>
</HTML>
