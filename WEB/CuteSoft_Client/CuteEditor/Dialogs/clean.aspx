...
<HTML>
	<head>
		...
		<script language="javascript">
			var OxO8541=["dialogArguments","ig","\x3C/?[^\x3E]*\x3E","","\x3C\x5C?xml[^\x3E]*\x3E","\x3C/?[a-z]+:[^\x3E]*\x3E","(\x3C[^\x3E]+) class=[^ |^\x3E]*([^\x3E]*\x3E)","$1 $2","(\x3C[^\x3E]+) style=\x22[^\x22]*\x22([^\x3E]*\x3E)","\x3Cspan[^\x3E]*\x3E\x3C/span[^\x3E]*\x3E","\x3Cspan\x3E\x3Cspan\x3E","\x3Cspan\x3E","\x3C/span\x3E\x3C/span\x3E","\x3C/span\x3E","[ ]*\x3E","\x3E","\x3C/?font[^\x3E]*\x3E","\x3C/?span[^\x3E]*\x3E","span","font","css","word","allhtml"];var editor=top[OxO8541[0x0]]; function execRE(Ox180,Ox4da,Ox4db){ oReg= new RegExp(Ox180,OxO8541[0x1]) ; r=Ox4db.replace(oReg,Ox4da) ;return r;}  ; function getContent(){return editor.getHTML();}  ; function setContent(Ox4db){ editor.setHTML(Ox4db) ;}  ; function codeCleaner(Ox318){var Ox4db=getContent();switch(Ox318){case OxO8541[0x16]: Ox4db=execRE(OxO8541[0x2],OxO8541[0x3],Ox4db) ;break ;case OxO8541[0x15]: Ox4db=execRE(OxO8541[0x4],OxO8541[0x3],Ox4db) ; Ox4db=execRE(OxO8541[0x5],OxO8541[0x3],Ox4db) ; Ox4db=execRE(OxO8541[0x6],OxO8541[0x7],Ox4db) ; Ox4db=execRE(OxO8541[0x8],OxO8541[0x7],Ox4db) ; Ox4db=execRE(OxO8541[0x9],OxO8541[0x3],Ox4db) ; Ox4db=execRE(OxO8541[0xa],OxO8541[0xb],Ox4db) ; Ox4db=execRE(OxO8541[0xc],OxO8541[0xd],Ox4db) ; Ox4db=execRE(OxO8541[0xe],OxO8541[0xf],Ox4db) ;break ;case OxO8541[0x14]: Ox4db=execRE(OxO8541[0x6],OxO8541[0x7],Ox4db) ; Ox4db=execRE(OxO8541[0x8],OxO8541[0x7],Ox4db) ;break ;case OxO8541[0x13]: Ox4db=execRE(OxO8541[0x10],OxO8541[0x3],Ox4db) ;break ;case OxO8541[0x12]: Ox4db=execRE(OxO8541[0x11],OxO8541[0x3],Ox4db) ;break ;;;;;;} ; setContent(Ox4db) ;}  ;
		</script>
		<style type=text/css>
			.codebutton
			{
