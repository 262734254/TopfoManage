...
<html>
	<head>
		...
		var OxO1bfe=["disabled","srcElement","[[Disabled]]","[[SpecifyNewFolderName]]","","value","hiddenActionData","[[CopyMoveto]]","/","[[AreyouSureDelete]]","parentNode","text","isdir",".","[[SpecifyNewFileName]]","hiddenAction","rename","path","True","False",":","cancelBubble","backgroundColor","style","#eeeeee","tagName","INPUT","changedir","hiddenFile","url","TargetUrl"]; function CreateDir_click(){if(event[OxO1bfe[0x1]][OxO1bfe[0x0]]){ alert(OxO1bfe[0x2]) ;return false;} ;var Ox2fb=prompt(OxO1bfe[0x3],OxO1bfe[0x4]);if(Ox2fb){ document.getElementById(OxO1bfe[0x6])[OxO1bfe[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Move_click(){if(event[OxO1bfe[0x1]][OxO1bfe[0x0]]){ alert(OxO1bfe[0x2]) ;return false;} ;var Ox2fb=prompt(OxO1bfe[0x7],OxO1bfe[0x8]);if(Ox2fb){ document.getElementById(OxO1bfe[0x6])[OxO1bfe[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Copy_click(){if(event[OxO1bfe[0x1]][OxO1bfe[0x0]]){ alert(OxO1bfe[0x2]) ;return false;} ;var Ox2fb=prompt(OxO1bfe[0x7],OxO1bfe[0x8]);if(Ox2fb){ document.getElementById(OxO1bfe[0x6])[OxO1bfe[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Delete_click(){if(event[OxO1bfe[0x1]][OxO1bfe[0x0]]){ alert(OxO1bfe[0x2]) ;return false;} ;return confirm(OxO1bfe[0x9]);}  ; function EditImg_click(Oxb9){if(Oxb9[OxO1bfe[0x0]]){ alert(OxO1bfe[0x2]) ;return false;} ; row=Oxb9[OxO1bfe[0xa]][OxO1bfe[0xa]] ;var Ox550=row[OxO1bfe[0xb]];var name;if(row[OxO1bfe[0xc]]){ name=prompt(OxO1bfe[0x3],Ox550) ;} else {var i=Ox550.lastIndexOf(OxO1bfe[0xd]);var Ox551=Ox550.substr(i);var Ox20=Ox550.substr(0x0,Ox550.lastIndexOf(OxO1bfe[0xd])); name=prompt(OxO1bfe[0xe],Ox20) ;if(name){ name=name+Ox551 ;} ;} ;if(name&&name!=row[OxO1bfe[0xb]]){ document.getElementById(OxO1bfe[0xf])[OxO1bfe[0x5]]=OxO1bfe[0x10] ; document.getElementById(OxO1bfe[0x6])[OxO1bfe[0x5]]=(row[OxO1bfe[0xc]]?OxO1bfe[0x12]:OxO1bfe[0x13])+OxO1bfe[0x14]+row[OxO1bfe[0x11]]+OxO1bfe[0x14]+name ; postback() ;} ; event[OxO1bfe[0x15]]=true ;}  ; function row_over(Oxc3){ Oxc3[OxO1bfe[0x17]][OxO1bfe[0x16]]=OxO1bfe[0x18] ;}  ; function row_out(Oxc3){ Oxc3[OxO1bfe[0x17]][OxO1bfe[0x16]]=OxO1bfe[0x4] ;}  ; function row_click(Oxc3){if(Oxc3[OxO1bfe[0xc]]){if(event[OxO1bfe[0x1]][OxO1bfe[0x19]]==OxO1bfe[0x1a]){return ;} ; document.getElementById(OxO1bfe[0xf])[OxO1bfe[0x5]]=OxO1bfe[0x1b] ; document.getElementById(OxO1bfe[0x6])[OxO1bfe[0x5]]=Oxc3.getAttribute(OxO1bfe[0x11]) ; postback() ;} else {var Ox4f4=Oxc3.getAttribute(OxO1bfe[0x11]); document.getElementById(OxO1bfe[0x1c])[OxO1bfe[0x5]]=Ox4f4 ;var Oxba=Oxc3.getAttribute(OxO1bfe[0x1d]); document.getElementById(OxO1bfe[0x1e])[OxO1bfe[0x5]]=Oxba ; do_preview() ;} ;}  ; function postback(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style>
		.row
		{
	...
	<body bottomMargin="0" topMargin="10" leftmargin="3" marginwidth="0" marginheight="0">
		<form runat="server" enctype="multipart/form-data" id="Form1">
			<!-- start hidden -->
			<script>
        var OxO4f50=["onload","value","hiddenAlert","","hiddenAction","hiddenActionData"]; window[OxO4f50[0x0]]=reset_hiddens ; function reset_hiddens(){if(document.getElementById(OxO4f50[0x2])[OxO4f50[0x1]]){ alert(document.getElementById(OxO4f50[0x2]).value) ;} ; document.getElementById(OxO4f50[0x2])[OxO4f50[0x1]]=OxO4f50[0x3] ; document.getElementById(OxO4f50[0x4])[OxO4f50[0x1]]=OxO4f50[0x3] ; document.getElementById(OxO4f50[0x5])[OxO4f50[0x1]]=OxO4f50[0x3] ;}  ;
			</script>
	...
	<script>
		...
		var OxOe63f=["dialogArguments","TargetUrl","value","","Width","Height","ShowControls","AutoStart","ShowStatusBar","checked","\x3Cembed name=\x22MediaPlayer1\x22 src=\x22","\x22 autostart=\x22","\x22 showcontrols=\x22","\x22  width=\x22","\x22 height=\x22","\x22 type=\x22application/x-mplayer2\x22 pluginspage=\x22http://www.microsoft.com/Windows/MediaPlayer\x22 \x3E\x3C/embed\x3E\x0A","innerHTML","Please choose a Media movie to insert","w","px","h","medianame","zoom","style"];var editor=top[OxOe63f[0x0]]; do_preview() ; function do_preview(){var Ox57b;var Ox81;var Ox2e2;var TargetUrl=document.getElementById(OxOe63f[0x1]);if(TargetUrl[OxOe63f[0x2]]==OxOe63f[0x3]){return ;} ;var Width=document.getElementById(OxOe63f[0x4]);var Height=document.getElementById(OxOe63f[0x5]);var Ox5bc=document.getElementById(OxOe63f[0x6]);var Ox5bd=document.getElementById(OxOe63f[0x7]);var Ox5be=document.getElementById(OxOe63f[0x8]);var Ox5bfOx5c0Ox5c1;if(Ox5bd[OxOe63f[0x9]]){ Ox5bf=0x1 ;} else { Ox5bf=0x0 ;} ;if(Ox5be[OxOe63f[0x9]]){ Ox5c0=0x1 ;} else { Ox5c0=0x0 ;} ;if(Ox5bc[OxOe63f[0x9]]){ Ox5c1=0x1 ;} else { Ox5c1=0x0 ;} ; Ox81=Width[OxOe63f[0x2]] ; Ox2e2=Height[OxOe63f[0x2]] ; preview_width=0xf0 ; preview_height=0xc8 ; w=parseInt(Ox81) ; h=parseInt(Ox2e2) ;if(w>h){ Ox81=preview_width ; Ox2e2=preview_height*h/w ;} else { Ox81=preview_width*w/h ; Ox2e2=preview_height ;} ; Ox81=parseInt(Ox81) ; Ox2e2=parseInt(Ox2e2) ;var Oxbd=OxOe63f[0xa]+TargetUrl[OxOe63f[0x2]]+OxOe63f[0xb]+Ox5bf+OxOe63f[0xc]+Ox5c1+OxOe63f[0xd]+Ox81+OxOe63f[0xe]+Ox2e2+OxOe63f[0xf]; divpreview[OxOe63f[0x10]]=Oxbd ;}  ;var parameters= new Array(); function do_insert(){var TargetUrl=document.getElementById(OxOe63f[0x1]);var Width=document.getElementById(OxOe63f[0x4]);var Height=document.getElementById(OxOe63f[0x5]);var Ox5bc=document.getElementById(OxOe63f[0x6]);var Ox5bd=document.getElementById(OxOe63f[0x7]);var Ox5be=document.getElementById(OxOe63f[0x8]);if(TargetUrl[OxOe63f[0x2]]==OxOe63f[0x3]){ alert(OxOe63f[0x11]) ;return false;} ; parameters[OxOe63f[0x12]]=Width[OxOe63f[0x2]]+OxOe63f[0x13] ; parameters[OxOe63f[0x14]]=Height[OxOe63f[0x2]]+OxOe63f[0x13] ; parameters[OxOe63f[0x15]]=document.getElementById(OxOe63f[0x1])[OxOe63f[0x2]] ;if(Ox5bd[OxOe63f[0x9]]){ parameters[OxOe63f[0x7]]=0x1 ;} else { parameters[OxOe63f[0x7]]=0x0 ;} ;if(Ox5be[OxOe63f[0x9]]){ parameters[OxOe63f[0x8]]=0x1 ;} else { parameters[OxOe63f[0x8]]=0x0 ;} ;if(Ox5bc[OxOe63f[0x9]]){ parameters[OxOe63f[0x6]]=0x1 ;} else { parameters[OxOe63f[0x6]]=0x0 ;} ;if(TargetUrl[OxOe63f[0x2]]==OxOe63f[0x3]){ alert(OxOe63f[0x11]) ;return false;} ;var Oxbd=OxOe63f[0xa]+parameters[OxOe63f[0x15]]+OxOe63f[0xb]+parameters[OxOe63f[0x7]]+OxOe63f[0xc]+parameters[OxOe63f[0x6]]+OxOe63f[0xd]+parameters[OxOe63f[0x12]]+OxOe63f[0xe]+parameters[OxOe63f[0x14]]+OxOe63f[0xf]; editor.PasteHTML(Oxbd) ; top.close() ;}  ; function do_cancel(){ top.close() ;}  ; function Zoom_In(){if(divpreview[OxOe63f[0x17]][OxOe63f[0x16]]!=0x0){ divpreview[OxOe63f[0x17]][OxOe63f[0x16]]*=1.2 ;} else { divpreview[OxOe63f[0x17]][OxOe63f[0x16]]=1.2 ;} ;}  ; function Zoom_Out(){if(divpreview[OxOe63f[0x17]][OxOe63f[0x16]]!=0x0){ divpreview[OxOe63f[0x17]][OxOe63f[0x16]]*=0.8 ;} else { divpreview[OxOe63f[0x17]][OxOe63f[0x16]]=0.8 ;} ;}  ; function Actualsize(){ divpreview[OxOe63f[0x17]][OxOe63f[0x16]]=0x1 ;}  ;
