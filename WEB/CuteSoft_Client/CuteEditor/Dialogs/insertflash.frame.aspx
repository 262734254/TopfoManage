...
<HTML>
	<HEAD>
		...
		var OxO549b=["disabled","srcElement","[[Disabled]]","[[SpecifyNewFolderName]]","","value","hiddenActionData","[[CopyMoveto]]","/","[[AreyouSureDelete]]","parentNode","text","isdir",".","[[SpecifyNewFileName]]","hiddenAction","rename","path","True","False",":","cancelBubble","backgroundColor","style","#eeeeee","tagName","INPUT","changedir","hiddenFile","url","TargetUrl"]; function CreateDir_click(){if(event[OxO549b[0x1]][OxO549b[0x0]]){ alert(OxO549b[0x2]) ;return false;} ;var Ox2fb=prompt(OxO549b[0x3],OxO549b[0x4]);if(Ox2fb){ document.getElementById(OxO549b[0x6])[OxO549b[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Move_click(){if(event[OxO549b[0x1]][OxO549b[0x0]]){ alert(OxO549b[0x2]) ;return false;} ;var Ox2fb=prompt(OxO549b[0x7],OxO549b[0x8]);if(Ox2fb){ document.getElementById(OxO549b[0x6])[OxO549b[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Copy_click(){if(event[OxO549b[0x1]][OxO549b[0x0]]){ alert(OxO549b[0x2]) ;return false;} ;var Ox2fb=prompt(OxO549b[0x7],OxO549b[0x8]);if(Ox2fb){ document.getElementById(OxO549b[0x6])[OxO549b[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Delete_click(){if(event[OxO549b[0x1]][OxO549b[0x0]]){ alert(OxO549b[0x2]) ;return false;} ;return confirm(OxO549b[0x9]);}  ; function EditImg_click(Oxb9){if(Oxb9[OxO549b[0x0]]){ alert(OxO549b[0x2]) ;return false;} ; row=Oxb9[OxO549b[0xa]][OxO549b[0xa]] ;var Ox550=row[OxO549b[0xb]];var name;if(row[OxO549b[0xc]]){ name=prompt(OxO549b[0x3],Ox550) ;} else {var i=Ox550.lastIndexOf(OxO549b[0xd]);var Ox551=Ox550.substr(i);var Ox20=Ox550.substr(0x0,Ox550.lastIndexOf(OxO549b[0xd])); name=prompt(OxO549b[0xe],Ox20) ;if(name){ name=name+Ox551 ;} ;} ;if(name&&name!=row[OxO549b[0xb]]){ document.getElementById(OxO549b[0xf])[OxO549b[0x5]]=OxO549b[0x10] ; document.getElementById(OxO549b[0x6])[OxO549b[0x5]]=(row[OxO549b[0xc]]?OxO549b[0x12]:OxO549b[0x13])+OxO549b[0x14]+row[OxO549b[0x11]]+OxO549b[0x14]+name ; postback() ;} ; event[OxO549b[0x15]]=true ;}  ; function row_over(Oxc3){ Oxc3[OxO549b[0x17]][OxO549b[0x16]]=OxO549b[0x18] ;}  ; function row_out(Oxc3){ Oxc3[OxO549b[0x17]][OxO549b[0x16]]=OxO549b[0x4] ;}  ; function row_click(Oxc3){if(Oxc3[OxO549b[0xc]]){if(event[OxO549b[0x1]][OxO549b[0x19]]==OxO549b[0x1a]){return ;} ; document.getElementById(OxO549b[0xf])[OxO549b[0x5]]=OxO549b[0x1b] ; document.getElementById(OxO549b[0x6])[OxO549b[0x5]]=Oxc3.getAttribute(OxO549b[0x11]) ; postback() ;} else {var Ox4f4=Oxc3.getAttribute(OxO549b[0x11]); document.getElementById(OxO549b[0x1c])[OxO549b[0x5]]=Ox4f4 ;var Oxba=Oxc3.getAttribute(OxO549b[0x1d]); document.getElementById(OxO549b[0x1e])[OxO549b[0x5]]=Oxba ; do_preview() ;} ;}  ; function postback(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style>
		.row { HEIGHT: 22px }
	...
	<body bottomMargin="0" topMargin="10" leftmargin="3" marginwidth="0" marginheight="0">
		<form runat="server" enctype="multipart/form-data" id="Form1">
			<!-- start hidden -->
			<script>
        var OxO380a=["onload","value","hiddenAlert","","hiddenAction","hiddenActionData"]; window[OxO380a[0x0]]=reset_hiddens ; function reset_hiddens(){if(document.getElementById(OxO380a[0x2])[OxO380a[0x1]]){ alert(document.getElementById(OxO380a[0x2]).value) ;} ; document.getElementById(OxO380a[0x2])[OxO380a[0x1]]=OxO380a[0x3] ; document.getElementById(OxO380a[0x4])[OxO380a[0x1]]=OxO380a[0x3] ; document.getElementById(OxO380a[0x5])[OxO380a[0x1]]=OxO380a[0x3] ;}  ;
			</script>
    ...
    protected int GetUsedSpaceBarWidth()
    {
      ...
      return w;      
		...
		<script>
			var OxO822a=["dialogArguments","TargetUrl","bgColortext","Width","Height","Quality","chk_Transparency","chk_Loop","chk_Autoplay","VSpace","HSpace","Align","Scale","divpreview","value","","scale=\x27noborder\x27","scale=\x27exactfit\x27","Exactfit","Noborder","hspace=\x22","\x22 ","vspace=\x22","align=\x22","checked","wmode=\x22transparent\x22","loop=\x22false\x22","play=\x22false\x22","bgcolor=\x22","\x22","\x3Cembed src=\x22","\x22 width=\x22"," "," height=\x22","\x22 quality=\x22","\x22 type=\x22application/x-shockwave-flash\x22 pluginspage=\x22http://www.macromedia.com/go/getflashplayer\x22\x3E\x3C/embed\x3E\x0A","innerHTML","Please choose a Flash movie to insert","\x22 height=\x22"," quality=\x22"," type=\x22application/x-shockwave-flash\x22 pluginspage=\x22http://www.macromedia.com/go/getflashplayer\x22\x3E\x3C/embed\x3E\x0A","\x3Cobject xcodebase=","\x22http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab\x22"," classid=","\x22clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\x22\x3E"," \x3CPARAM name=\x22Movie\x22 value=\x22","\x22 /\x3E"," \x3CPARAM name=\x22Quality\x22 value=\x22","\x22/\x3E","\x3Cparam name=\x22wmode\x22 value=\x22transparent\x22/\x3E","\x3Cparam name=\x22loop\x22 value=\x22false\x22/\x3E","\x3Cparam name=\x22play\x22 value=\x22false\x22/\x3E","\x3Cparam name=\x22scale\x22 value=\x22","\x3Cparam name=\x22bgcolor\x22 value=\x22","\x3C/object\x3E","zoom","style","keyCode","[[ValidNumber]]"];var editor=top[OxO822a[0x0]];var flashname=document.getElementById(OxO822a[0x1]);var bgColortext=document.getElementById(OxO822a[0x2]);var Width=document.getElementById(OxO822a[0x3]);var Height=document.getElementById(OxO822a[0x4]);var Quality=document.getElementById(OxO822a[0x5]);var chk_Transparency=document.getElementById(OxO822a[0x6]);var chk_Loop=document.getElementById(OxO822a[0x7]);var chk_Autoplay=document.getElementById(OxO822a[0x8]);var VSpace=document.getElementById(OxO822a[0x9]);var HSpace=document.getElementById(OxO822a[0xa]);var Align=document.getElementById(OxO822a[0xb]);var Scale=document.getElementById(OxO822a[0xc]);var divpreview=document.getElementById(OxO822a[0xd]);var bgColortext=document.getElementById(OxO822a[0x2]); do_preview() ; function do_preview(){var Oxba;var Ox57b;var Ox563;var Ox81;var Ox2e2;var Ox57c; Oxba=flashname[OxO822a[0xe]] ; Ox81=Width[OxO822a[0xe]] ; Ox2e2=Height[OxO822a[0xe]] ; Ox57c=Quality[OxO822a[0xe]] ; preview_width=0xf0 ; preview_height=0xc8 ; w=parseInt(Ox81) ; h=parseInt(Ox2e2) ;if(w>h){ Ox81=preview_width ; Ox2e2=preview_height*h/w ;} else { Ox81=preview_width*w/h ; Ox2e2=preview_height ;} ; Ox81=parseInt(Ox81) ; Ox2e2=parseInt(Ox2e2) ;if(Oxba==OxO822a[0xf]){return ;} ;var Ox57dOx57eOx57fOx580Ox581Ox582;switch(Scale[OxO822a[0xe]]){case OxO822a[0x13]: Ox581=OxO822a[0x10] ;break ;case OxO822a[0x12]: Ox581=OxO822a[0x11] ;break ;case OxO822a[0xf]: Ox581=OxO822a[0xf] ;break ;;;;} ; Ox582=OxO822a[0xf] ;if(HSpace[OxO822a[0xe]]){ Ox582=Ox582+OxO822a[0x14]+HSpace[OxO822a[0xe]]+OxO822a[0x15] ;} ;if(VSpace[OxO822a[0xe]]){ Ox582=Ox582+OxO822a[0x16]+VSpace[OxO822a[0xe]]+OxO822a[0x15] ;} ;if(Align[OxO822a[0xe]]){ Ox582=Ox582+OxO822a[0x17]+Align[OxO822a[0xe]]+OxO822a[0x15] ;} ; Ox57d=chk_Transparency[OxO822a[0x18]]?OxO822a[0x19]:OxO822a[0xf] ; Ox57e=chk_Loop[OxO822a[0x18]]?OxO822a[0xf]:OxO822a[0x1a] ; Ox57f=chk_Autoplay[OxO822a[0x18]]?OxO822a[0xf]:OxO822a[0x1b] ; Ox580=bgColortext[OxO822a[0xe]]==OxO822a[0xf]?OxO822a[0xf]:OxO822a[0x1c]+bgColortext[OxO822a[0xe]]+OxO822a[0x1d] ;var Ox563=OxO822a[0x1e]+Oxba+OxO822a[0x1f]+Ox81+OxO822a[0x15]+Ox582+OxO822a[0x20]+Ox57d+OxO822a[0x20]+Ox57e+OxO822a[0x20]+Ox57f+OxO822a[0x20]+Ox580+OxO822a[0x20]+Ox581+OxO822a[0x21]+Ox2e2+OxO822a[0x22]+Ox57c+OxO822a[0x23]; divpreview[OxO822a[0x24]]=Ox563 ;}  ;var parameters= new Array(); function do_insert(){if(flashname[OxO822a[0xe]]==OxO822a[0xf]){ alert(OxO822a[0x25]) ;return false;} ;var Ox2ehOx583Ox584Ox57cOxba; Ox2e=Width[OxO822a[0xe]]+OxO822a[0xf] ; h=Height[OxO822a[0xe]]+OxO822a[0xf] ; Ox583=chk_Transparency[OxO822a[0xe]] ; Ox57c=Quality[OxO822a[0xe]] ; Oxba=flashname[OxO822a[0xe]] ;var Ox57dOx57eOx57fOx580Ox581Ox582;switch(Scale[OxO822a[0xe]]){case OxO822a[0x13]: Ox581=OxO822a[0x10] ;break ;case OxO822a[0x12]: Ox581=OxO822a[0x11] ;break ;case OxO822a[0xf]: Ox581=OxO822a[0xf] ;break ;;;;} ; Ox582=OxO822a[0xf] ;if(HSpace[OxO822a[0xe]]){ Ox582=Ox582+OxO822a[0x14]+HSpace[OxO822a[0xe]]+OxO822a[0x15] ;} ;if(VSpace[OxO822a[0xe]]){ Ox582=Ox582+OxO822a[0x16]+VSpace[OxO822a[0xe]]+OxO822a[0x15] ;} ;if(Align[OxO822a[0xe]]){ Ox582=Ox582+OxO822a[0x17]+Align[OxO822a[0xe]]+OxO822a[0x15] ;} ; Ox57d=chk_Transparency[OxO822a[0x18]]?OxO822a[0x19]:OxO822a[0xf] ; Ox57e=chk_Loop[OxO822a[0x18]]?OxO822a[0xf]:OxO822a[0x1a] ; Ox57f=chk_Autoplay[OxO822a[0x18]]?OxO822a[0xf]:OxO822a[0x1b] ; Ox580=bgColortext[OxO822a[0xe]]==OxO822a[0xf]?OxO822a[0xf]:OxO822a[0x1c]+bgColortext[OxO822a[0xe]]+OxO822a[0x1d] ;var Ox585=OxO822a[0x1e]+Oxba+OxO822a[0x1f]+Ox2e+OxO822a[0x26]+h+OxO822a[0x15]+Ox582+OxO822a[0x27]+Ox57c+OxO822a[0x15]+Ox57d+OxO822a[0x20]+Ox57e+OxO822a[0x20]+Ox57f+OxO822a[0x20]+Ox580+OxO822a[0x20]+Ox581+OxO822a[0x28];var Oxbe=OxO822a[0x29]+OxO822a[0x2a]+OxO822a[0x21]+h+OxO822a[0x1f]+Ox2e+OxO822a[0x15]+Ox582+OxO822a[0x2b]+OxO822a[0x2c]+OxO822a[0x2d]+Oxba+OxO822a[0x2e]+OxO822a[0x2f]+Ox57c+OxO822a[0x30];if(chk_Transparency[OxO822a[0x18]]){ Oxbe=Oxbe+OxO822a[0x31] ;} ;if(!chk_Loop[OxO822a[0x18]]){ Oxbe=Oxbe+OxO822a[0x32] ;} ;if(!chk_Loop[OxO822a[0x18]]){ Oxbe=Oxbe+OxO822a[0x32] ;} ;if(!chk_Autoplay[OxO822a[0x18]]){ Oxbe=Oxbe+OxO822a[0x33] ;} ;if(Scale[OxO822a[0xe]]!=OxO822a[0xf]){ Oxbe=Oxbe+OxO822a[0x34]+Scale[OxO822a[0xe]]+OxO822a[0x30] ;} ;if(bgColortext[OxO822a[0xe]]!=OxO822a[0xf]){ Oxbe=Oxbe+OxO822a[0x35]+bgColortext[OxO822a[0xe]]+OxO822a[0x30] ;} ; Oxbe=Oxbe+Ox585+OxO822a[0x36] ; editor.PasteHTML(Oxbe) ; top.close() ;}  ; function do_cancel(){ top.close() ;}  ; divpreview[OxO822a[0x38]][OxO822a[0x37]]=0x1 ; function Zoom_In(){if(divpreview[OxO822a[0x38]][OxO822a[0x37]]!=0x0){ divpreview[OxO822a[0x38]][OxO822a[0x37]]*=1.2 ;} else { divpreview[OxO822a[0x38]][OxO822a[0x37]]=1.2 ;} ;}  ; function Zoom_Out(){if(divpreview[OxO822a[0x38]][OxO822a[0x37]]!=0x0){ divpreview[OxO822a[0x38]][OxO822a[0x37]]*=0.8 ;} else { divpreview[OxO822a[0x38]][OxO822a[0x37]]=0.8 ;} ;}  ; function Actualsize(){ divpreview[OxO822a[0x38]][OxO822a[0x37]]=0x1 ;}  ; function IsDigit(){if((event[OxO822a[0x39]]>=0x30)&&(event[OxO822a[0x39]]<=0x39)||event[OxO822a[0x39]]==0x25){return true;} else { alert(OxO822a[0x3a]) ;return false;} ;}  ;
		</script>
	</body>
</HTML>
