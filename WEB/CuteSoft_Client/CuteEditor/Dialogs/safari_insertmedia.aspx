...
<html>
	<head>
		...
		var OxO5821=["disabled","target","[[Disabled]]","[[SpecifyNewFolderName]]","","value","hiddenActionData","[[CopyMoveto]]","/","[[AreyouSureDelete]]","parentNode","text","isdir",".","[[SpecifyNewFileName]]","hiddenAction","rename","path","True","False",":","cancelBubble","backgroundColor","style","#eeeeee","tagName","INPUT","changedir","hiddenFile","url","TargetUrl"]; function CreateDir_click(){if(event[OxO5821[0x1]][OxO5821[0x0]]){ alert(OxO5821[0x2]) ;return false;} ;var Ox2fb=prompt(OxO5821[0x3],OxO5821[0x4]);if(Ox2fb){ document.getElementById(OxO5821[0x6])[OxO5821[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Move_click(){if(event[OxO5821[0x1]][OxO5821[0x0]]){ alert(OxO5821[0x2]) ;return false;} ;var Ox2fb=prompt(OxO5821[0x7],OxO5821[0x8]);if(Ox2fb){ document.getElementById(OxO5821[0x6])[OxO5821[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Copy_click(){if(event[OxO5821[0x1]][OxO5821[0x0]]){ alert(OxO5821[0x2]) ;return false;} ;var Ox2fb=prompt(OxO5821[0x7],OxO5821[0x8]);if(Ox2fb){ document.getElementById(OxO5821[0x6])[OxO5821[0x5]]=Ox2fb ;return true;} else {return false;} ;}  ; function Delete_click(){if(event[OxO5821[0x1]][OxO5821[0x0]]){ alert(OxO5821[0x2]) ;return false;} ;return confirm(OxO5821[0x9]);}  ; function EditImg_click(Oxb9){if(Oxb9[OxO5821[0x0]]){ alert(OxO5821[0x2]) ;return false;} ; row=Oxb9[OxO5821[0xa]][OxO5821[0xa]] ;var Ox550=row[OxO5821[0xb]];var name;if(row[OxO5821[0xc]]){ name=prompt(OxO5821[0x3],Ox550) ;} else {var i=Ox550.lastIndexOf(OxO5821[0xd]);var Ox551=Ox550.substr(i);var Ox20=Ox550.substr(0x0,Ox550.lastIndexOf(OxO5821[0xd])); name=prompt(OxO5821[0xe],Ox20) ;if(name){ name=name+Ox551 ;} ;} ;if(name&&name!=row[OxO5821[0xb]]){ document.getElementById(OxO5821[0xf])[OxO5821[0x5]]=OxO5821[0x10] ; document.getElementById(OxO5821[0x6])[OxO5821[0x5]]=(row[OxO5821[0xc]]?OxO5821[0x12]:OxO5821[0x13])+OxO5821[0x14]+row[OxO5821[0x11]]+OxO5821[0x14]+name ; postback() ;} ; event[OxO5821[0x15]]=true ;}  ; function row_over(Oxc3){ Oxc3[OxO5821[0x17]][OxO5821[0x16]]=OxO5821[0x18] ;}  ; function row_out(Oxc3){ Oxc3[OxO5821[0x17]][OxO5821[0x16]]=OxO5821[0x4] ;}  ; function row_click(Oxc3){if(Oxc3[OxO5821[0xc]]){if(event[OxO5821[0x1]][OxO5821[0x19]]==OxO5821[0x1a]){return ;} ; document.getElementById(OxO5821[0xf])[OxO5821[0x5]]=OxO5821[0x1b] ; document.getElementById(OxO5821[0x6])[OxO5821[0x5]]=Oxc3.getAttribute(OxO5821[0x11]) ; postback() ;} else {var Ox4f4=Oxc3.getAttribute(OxO5821[0x11]); document.getElementById(OxO5821[0x1c])[OxO5821[0x5]]=Ox4f4 ;var Oxba=Oxc3.getAttribute(OxO5821[0x1d]); document.getElementById(OxO5821[0x1e])[OxO5821[0x5]]=Oxba ; do_preview() ;} ;}  ; function postback(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style>
		.row
		{
	...
	<body>
		<form runat="server" enctype="multipart/form-data" id="Form1">
			<!-- start hidden -->
			<script>
        var OxOcbe3=["onload","value","hiddenAlert","","hiddenAction","hiddenActionData"]; window[OxOcbe3[0x0]]=reset_hiddens ; function reset_hiddens(){if(document.getElementById(OxOcbe3[0x2])[OxOcbe3[0x1]]){ alert(document.getElementById(OxOcbe3[0x2]).value) ;} ; document.getElementById(OxOcbe3[0x2])[OxOcbe3[0x1]]=OxOcbe3[0x3] ; document.getElementById(OxOcbe3[0x4])[OxOcbe3[0x1]]=OxOcbe3[0x3] ; document.getElementById(OxOcbe3[0x5])[OxOcbe3[0x1]]=OxOcbe3[0x3] ;}  ;
			</script>
	...
	<script>
		...
		var OxO1e2d=["availWidth","availHeight","TargetUrl","value","","Width","Height","ShowControls","AutoStart","ShowStatusBar","checked","\x3Cembed name=\x22MediaPlayer1\x22 src=\x22","\x22 autostart=\x22","\x22 showcontrols=\x22","\x22  width=\x22","\x22 height=\x22","\x22 type=\x22application/x-mplayer2\x22 pluginspage=\x22http://www.microsoft.com/Windows/MediaPlayer\x22 \x3E\x3C/embed\x3E\x0A","innerHTML","Please choose a Media movie to insert","w","px","h","medianame","dialogArguments","opener"]; window.resizeTo(0x23c,0x21c) ; window.moveTo((screen[OxO1e2d[0x0]]-0x258)/0x2,(screen[OxO1e2d[0x1]]-0x190)/0x2) ; window.focus() ; do_preview() ; function do_preview(){var Ox57b;var Ox81;var Ox2e2;var TargetUrl=document.getElementById(OxO1e2d[0x2]);if(TargetUrl[OxO1e2d[0x3]]==OxO1e2d[0x4]){return ;} ;var Width=document.getElementById(OxO1e2d[0x5]);var Height=document.getElementById(OxO1e2d[0x6]);var Ox5bc=document.getElementById(OxO1e2d[0x7]);var Ox5bd=document.getElementById(OxO1e2d[0x8]);var Ox5be=document.getElementById(OxO1e2d[0x9]);var Ox5bfOx5c0Ox5c1;if(Ox5bd[OxO1e2d[0xa]]){ Ox5bf=0x1 ;} else { Ox5bf=0x0 ;} ;if(Ox5be[OxO1e2d[0xa]]){ Ox5c0=0x1 ;} else { Ox5c0=0x0 ;} ;if(Ox5bc[OxO1e2d[0xa]]){ Ox5c1=0x1 ;} else { Ox5c1=0x0 ;} ; Ox81=Width[OxO1e2d[0x3]] ; Ox2e2=Height[OxO1e2d[0x3]] ; preview_width=0xf0 ; preview_height=0xc8 ; w=parseInt(Ox81) ; h=parseInt(Ox2e2) ;if(w>h){ Ox81=preview_width ; Ox2e2=preview_height*h/w ;} else { Ox81=preview_width*w/h ; Ox2e2=preview_height ;} ; Ox81=parseInt(Ox81) ; Ox2e2=parseInt(Ox2e2) ;var Oxbd=OxO1e2d[0xb]+TargetUrl[OxO1e2d[0x3]]+OxO1e2d[0xc]+Ox5bf+OxO1e2d[0xd]+Ox5c1+OxO1e2d[0xe]+Ox81+OxO1e2d[0xf]+Ox2e2+OxO1e2d[0x10]; divpreview[OxO1e2d[0x11]]=Oxbd ;}  ;var parameters= new Array(); function do_insert(){var TargetUrl=document.getElementById(OxO1e2d[0x2]);var Width=document.getElementById(OxO1e2d[0x5]);var Height=document.getElementById(OxO1e2d[0x6]);var Ox5bc=document.getElementById(OxO1e2d[0x7]);var Ox5bd=document.getElementById(OxO1e2d[0x8]);var Ox5be=document.getElementById(OxO1e2d[0x9]);if(TargetUrl[OxO1e2d[0x3]]==OxO1e2d[0x4]){ alert(OxO1e2d[0x12]) ;return false;} ; parameters[OxO1e2d[0x13]]=Width[OxO1e2d[0x3]]+OxO1e2d[0x14] ; parameters[OxO1e2d[0x15]]=Height[OxO1e2d[0x3]]+OxO1e2d[0x14] ; parameters[OxO1e2d[0x16]]=document.getElementById(OxO1e2d[0x2])[OxO1e2d[0x3]] ;if(Ox5bd[OxO1e2d[0xa]]){ parameters[OxO1e2d[0x8]]=0x1 ;} else { parameters[OxO1e2d[0x8]]=0x0 ;} ;if(Ox5be[OxO1e2d[0xa]]){ parameters[OxO1e2d[0x9]]=0x1 ;} else { parameters[OxO1e2d[0x9]]=0x0 ;} ;if(Ox5bc[OxO1e2d[0xa]]){ parameters[OxO1e2d[0x7]]=0x1 ;} else { parameters[OxO1e2d[0x7]]=0x0 ;} ;if(TargetUrl[OxO1e2d[0x3]]==OxO1e2d[0x4]){ alert(OxO1e2d[0x12]) ;return false;} ;var Oxbd=OxO1e2d[0xb]+parameters[OxO1e2d[0x16]]+OxO1e2d[0xc]+parameters[OxO1e2d[0x8]]+OxO1e2d[0xd]+parameters[OxO1e2d[0x7]]+OxO1e2d[0xe]+parameters[OxO1e2d[0x13]]+OxO1e2d[0xf]+parameters[OxO1e2d[0x15]]+OxO1e2d[0x10];var editor=window[OxO1e2d[0x18]][OxO1e2d[0x17]]; editor.PasteHTML(Oxbd) ; top.close() ;}  ; function do_cancel(){ top.close() ;}  ;
