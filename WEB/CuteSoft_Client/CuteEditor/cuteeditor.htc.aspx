...
var OxOc143=["cursor","style","progress","[[_setting_]]","[[_CuteEditorResource_]]","\x26[[DNN_Arg]]"];var htcmode=true;var editor=element;try{ editor[OxOc143[0x1]][OxOc143[0x0]]=OxOc143[0x2] ;} catch(x){} ;var _setting_=OxOc143[0x3];var _CuteEditorResource_=OxOc143[0x4];var colorpickerurl='<%=ProcessWebPath("ColorPicker.Aspx")%>?culture=[[_culture_]]'+OxOc143[0x5];var cpuspeed=0x3e8;
...
<SCRIPT>
var OxO637d=["document"]; TestFrameReady() ; function TestFrameReady(){if(editor[OxO637d[0x0]].getElementById(editor._FrameID)){ StartInitialize() ;} else { setTimeout(TestFrameReady,0xa) ;} ;}  ;
</SCRIPT>