<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModefiyProService.aspx.cs"
    Inherits="ProfessionalManage_ModefiyProService" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="one_table">
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <span class="hui">（如：专业服务详情页-中国招商投资网）</span></td>
                </tr>
                <tr>
                    <td>
                ...
                <%--<tr>
                    <td>
                        专业类型：</td>
                    <td align="left">
                        <asp:RadioButton ID="rdoService" GroupName="rbltype" runat="server" Checked="True"
                            Text="需要服务"></asp:RadioButton>
                        <asp:RadioButton ID="rdoPress" GroupName="rbltype" runat="server" Text="提供专业"></asp:RadioButton>
                        <asp:RadioButton ID="rdoPressPerson" GroupName="rbltype" runat="server" Text="专业人才">
                        </asp:RadioButton>
                    </td>
                </tr>--%>
                <tr>
