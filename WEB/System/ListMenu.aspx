<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListMenu.aspx.cs" Inherits="System_ListMenu" %>
        ...
        <span id="span2"></span>&nbsp;<table class="small" cellspacing="0" cellpadding="3"
            ...
            <tr>
                <td class="Big">
                    ...
                    <input class="btn" onclick="mysubmit();" type="button" value="确定" id="Button1" />&nbsp;&nbsp;
