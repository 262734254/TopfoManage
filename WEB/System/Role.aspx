<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Role.aspx.cs" Inherits="System_Role" %>
...
<body>
    ...
    <div class="title"><h2><p><span><b>角色管理</b></span></p></h2></div>
    
        <asp:GridView ID="GridRoleTab" runat="server" AutoGenerateColumns="False" DataKeyNames="SRoleID" ShowFooter="True" CssClass="one_table two_table" OnRowDataBound="GridRoleTab_RowDataBound">
            <Columns> 
           ...
           <asp:Label ID="lbname" runat="server" Text='<%#Eval("SRCheck").ToString()=="1"?"已通过":"未通过"%>'>
                ...
                <asp:TemplateField HeaderText="审核">
                    ...
                    <ItemTemplate>
                     ...
                     <a href="CheckRole.aspx?SRoleID=<%#Eval("SRoleID")%>">审核</a>
                    </ItemTemplate>
                  </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="权限">
                    ...
                    <ItemTemplate>
                      ...
                      <a href="ListMenu.aspx?SRoleID=<%#Eval("SRoleID")%>">权限</a>
                    </ItemTemplate>
                </asp:TemplateField>
                
                <asp:TemplateField HeaderText="查看用户">
                    <EditItemTemplate>
                    ...
                    <ItemTemplate>
                        ...
                        <%--<asp:LinkButton ID="LinkQuan" runat="server" CommandArgument='<%# Eval("SRoleID") %>' OnClick="LinkQuan_Click">权限</asp:LinkButton>--%>
                      <a href="UserList.aspx?tem=<%#Eval("SRoleID")%>">查看用户</a>
                    </ItemTemplate>
                </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="删除">
                    ...
                    <ItemTemplate>
                      ...
                      <%--<asp:LinkButton ID="LinkDelete" runat="server" CommandArgument='<%# Eval("SRoleID") %>' OnClientClick="return confirm('是否删除！')" OnClick="LinkDelete_Click">删除</asp:LinkButton>--%>
                        <a href="DelRole.aspx?id=<%# Eval("SRoleID") %>" onclick='return confirm("删除后无法恢复!")'>删除</a>
                    </ItemTemplate>
                  </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="修改">
                    ...
                    <ItemTemplate>
                        ...
                        <a href="InsertRoleTab.aspx?SRoleID=<%#Eval("SRoleID")%>">查看/修改</a>
                    </ItemTemplate>
                </asp:TemplateField>
