<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModefiyMenu.aspx.cs" Inherits="System_ModefiyMenu" %>
         ...
         <div class="title"><h2><p><span><b>
          ...
          <table border="0" cellpadding="0" cellspacing="0" class="one_table" style="width: 612px; height: 124px">
                <tr>
                    ...
                    <asp:TextBox ID="txtMuneName" runat="server" onkeyup="a();" onblur="a();" 
                            Height="26px" Width="162px" AutoCompleteType="Email"></asp:TextBox>&nbsp;
                ...
                <tr>
                    ...
                    <td align="left"  valign="middle">
                        ...
                        <asp:TextBox ID="txtOrder" runat="server" Width="163px" Height="27px"></asp:TextBox>
                        </div> 
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button ID="Button2" runat="server" OnClientClick="return  b();" Text="修改" OnClick="Button1_Click" CssClass="btn" />
                        &nbsp;&nbsp;
