<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddProductType.aspx.cs" Inherits="productType_AddProductType" %>
...
<body>
    <form id="form1" runat="server">
        <div class="title" align="center">
            ...
            <h2><p><span><b>添加产品类别</b></span></p></h2>
        </div>
        <table width="100%" cellpadding="0" cellspacing="0" class="one_table">
            ...
            <tr>
                <td colspan="2" align="center" style="height: 24px">
                    <asp:Button runat="server" ID="BtnSvae" OnClientClick="return _Check();"
                        CssClass="btn" Text="添加" OnClick="BtnSvae_Click" />
