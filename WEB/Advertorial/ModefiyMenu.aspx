<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModefiyMenu.aspx.cs" Inherits="Advertorial_ModefiyMenu" %>
...
<head id="Head1" runat="server">
    ...
    var classId=document.getElementById("<%=classIds.ClientID %>").value;
...
<body>
    <form id="form1" runat="server">
        <div align="center">
         <input id="classIds" type="hidden"  runat="server"/>
            <div class="title">
                <h2>
                    <p>
                        <span><b>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="one_table" style="width: 612px;
                ...
                <tr>
                    ...
                    <td align="left" style="width: 333px; display: inline;" valign="middle">
                        <asp:TextBox ID="txtMuneName" runat="server" onkeyup="a();" onblur="a();" Height="21px"
                            Width="163px" AutoCompleteType="Email"></asp:TextBox>&nbsp;
                ...
                <tr>
                    ...
                    <td align="left" valign="middle">
                        <asp:TextBox ID="txtUrlAdd" runat="server" Width="379px" Height="107px" TextMode="MultiLine"></asp:TextBox>
                        <div style="display: inline; text-align: left; font-size: 13px;">
                ...
                <tr>
                    <td style="width: 23%" align="center">
                        是否启动：</td>
                    <td align="left">
                        <asp:RadioButton ID="rdoQidong" GroupName="rdo" runat="server" Text="启动" />
                        <asp:RadioButton ID="rdoClose" runat="server" GroupName="rdo" Text="关闭" /></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:Button ID="Button2" runat="server" OnClientClick="return  b();" Text="修改" OnClick="Button1_Click"
                            CssClass="btn" />
                        &nbsp;&nbsp;
