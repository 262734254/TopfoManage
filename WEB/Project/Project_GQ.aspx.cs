...
public partial class Project_Project_GQ : System.Web.UI.Page
{
    ...
    public void GetInfoModel()
    {
        ...
        ViewState["LoginName"] = model.MainInfoModel.LoginName.ToString();
        ...
        this.txtPointCount.Text = model.MainInfoModel.MainPointCount.ToString().Trim();
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        model.MainInfoModel.LoginName = Convert.ToString(ViewState["LoginName"].ToString().Trim());
        ...
        //项目摘要
        model.ProjectInfoModel.ComBrief = Tz888.Common.Utility.PageValidate.TxtToHtml(Tz888.Common.Utility.PageValidate.FiltrateHTMLTag(txtProIntro.Value.Trim())); 
