    ...
    public partial class MerchantInfoAddressInfo : System.Web.UI.UserControl
    {
        ...
        public Tz888.Model.Info.InfoContactModel InfoContact
        {
            get
            {
                ...
                this._infoContact.TelCountryCode = telCountry.Trim();
                this._infoContact.TelStateCode = telZoneCode.Trim();
                this._infoContact.TelNum = telNumber.Trim();
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        this.txtTelCountry.Text = value.TelCountryCode.Trim();
                        this._infoContact.TelCountryCode = value.TelCountryCode.Trim();
                    }
                    if (!string.IsNullOrEmpty(value.TelStateCode))
                    {
                        this.txtTelZoneCode.Text = value.TelStateCode.Trim();
                        this._infoContact.TelStateCode = value.TelStateCode.Trim();
                    }
                    if (!string.IsNullOrEmpty(value.TelNum))
                    {
                        this.txtTelNumber.Text = value.TelNum.Trim();
                        this._infoContact.TelNum = value.TelNum.Trim();
                    }
        ...
        //{
        //    this.CheckComPublishInfo1.TheInfoType = "merchant";
        //    this.CheckComPublishInfo1.OrganizationName = txtCompanyName.Text.Trim();
        //    this.CheckComPublishInfo1.StrCriteria = "OrganizationName like '%" + this.txtCompanyName.Text.Trim() + "%'";
        //    this.CheckComPublishInfo1.CheckConflict();
        //}
    }
}