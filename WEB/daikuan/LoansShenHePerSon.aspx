<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="LoansShenHePerSon.aspx.cs" Inherits="Publish_LoansShenHe" %>
    ...
    <div class="mainconbox">
        ...
        <table class="one_table" style="width: 751px">
            <tr>
                ...
                <td width="625" style="height: 63px">
                    <strong>
            ...
            <tr>
                <td >
                    <span style ="color:Red">*</span> <strong>借款总金额：</strong></td>
                <td>
            ...
            <tr>
                <td >
                    <span style ="color:Red">* </span><strong>借款期限：</strong></td>
                <td >
            ...
            <tr id="trids"  runat="server">
                <td >
                    <span style ="color:Red">* </span><strong>还款方式：</strong></td>
                <td >
           ...
           <tr>
            ...
            <tr>
                <td ">
                    <span style ="color:Red">*</span> <strong>借款用途及还款说明：</strong>
                    <br /></td>
                <td >
                    <label>
                    ...
                    &nbsp;<div id="showdescript" style ="display:none; color:Red ; font-size:12px">*</div>
                      ...
                      <tr>
                <td>
                    <span class="hong"></span><strong>联系方式：</strong></td>
                <td>
                    &nbsp;
            ...
            <tr>
                <td>
                    <span style ="color:Red">*</span><strong>姓名：</strong></td>
                <td >
                    <strong>
            ...
            <tr>
                <td>
                    <span></span> <strong>手机号码：</strong></td>
                <td>
            ...
            <tr>
                <td >
                    <span style ="color:Red">*</span> <strong>电话：</strong></td>
                <td>
            ...
            <tr>
               ...
               <tr id="shenhe"  style ="display:none";  runat ="server">
                <td>
                    <span></span><strong>未通过审核原因：</strong></td>
                <td >
                        ...
                        <script>function getStr(str)
        {
          ...
          <tr> <td colspan="2"  align="center">  &nbsp;<asp:Button ID="btnUpdate" runat="server"  CssClass="btn" OnClientClick="return chea()" OnClick="btnUpdate_Click" Text="审 核" />
