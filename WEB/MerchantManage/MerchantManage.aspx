<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MerchantManage.aspx.cs" Inherits="MerchantManage_MerchantManage" %>
...
function recommNavigate(infoID)
{
    ...
    {
    var url="";
    url="RecommResource.aspx?typeId=1&infoID="+infoID;
...
<body>
    ...
    <div align="center">
            <div class="title">
                <h2>
                    <p>
                        <span><b>招商信息列表</b></span></p>
                </h2>
               
                <h2>
                    <p>
                        <span><b><a href="MyRecommResource.aspx">我推荐的资源</a> </b></span></p>
                </h2>
            </div>
                        ...
                        <td style="width: 100px">
                          <label>
                            ...
                            <a href='JavaScript:recommNavigate("<%#Eval("InfoID") %>");'><%#getStatu(Convert.ToInt32(Eval("AuditingStatus")))%></a>
                                <asp:LinkButton ID="lbdel" CommandArgument='<%#Eval("InfoID")%>' CommandName="del"  runat="server" OnCommand="LinkButton1_Command" ToolTip="删除本条记录" OnClientClick="return confirm('确认删除此文件?');">删除</asp:LinkButton>
    ...
    <tr>
            <td align="left" style="height: 24px" >
                生成招商首页：<asp:TextBox ID="txtIndex" runat="server" Width="247px">http://zs.topfo.com/index.aspx</asp:TextBox>&nbsp;
         
            <asp:Button ID="btnIndexStatic"  CssClass="btn"  OnClientClick="return Fun();" runat="server" Text=" 生成" OnClick="btnIndexStatic_Click" />&nbsp;
            </td>
    </tr>
    </table>
            <br />
    <div>
     ...
     <a href="Javascript:SelectAll();">全选</a>/<a
                    href="Javascript:ReSelect();">反选</a>&nbsp;将选中的资讯<asp:Button ID="Button1" runat="server"
                        ...
                        <asp:Button ID="Button2" runat="server" Text="加入邮件" CssClass="btn" OnClick="Button2_Click"/>
                        
        <asp:Button ID="btnStatic" runat="server" OnClientClick="return Fun();" CssClass="btn" OnClick="btnStatic_Click"
            Text="批量生成" />
            <input type="button" class="btn" value="资源发布" onclick="javascript:location.href='AddMerchant.aspx'" />
