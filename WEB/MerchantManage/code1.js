...
mSift.prototype={
	...
	Varsion:'v2011.07.06 by longbin | ',
	Target:Object,
	TgList:Object,
	Listeners:null,
	SelIndex:0,
	...
	Get:function(){
		...
		for(var i=0;i<_this.ReData.length;i++){
			...
			//background:#ff9   color:#e60;按键改变当前字的背景、颜色
			...
			+_this.ReData[i].replace(cRegEx,function(s){return '<span style="font-weight:bold;font-style:normal;">'+s+'</span>';});+'</li>';
		}
		if(cResult==''){_this.Clear();}
		else{
			_this.TgList.innerHTML=cResult;
			_this.TgList.style.cssText='display:block;position:absolute;background:#fff;border:#847D84 solid 1px;margin:-1px 0 0;padding: 5px;list-style:none;font-size:12px;';
