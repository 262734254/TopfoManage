<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyResDong.aspx.cs" Inherits="tuijian_ModifyResDong" %>
...
<body>
   ...
   <table style="border-color:#678897; border-style:solid;  border-collapse:collapse; height:180px; "
                ...
                <tr><td >&nbsp;</td><td style="width: 357px">
                    <asp:Button ID="Button1" runat="server" Text="确认修改" OnClick="Button1_Click" CssClass="btn" /></td></tr>
                </table>
    </form>
    </div>
</body>
