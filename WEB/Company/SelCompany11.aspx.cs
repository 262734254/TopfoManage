...
public partial class Company_SelCompany : System.Web.UI.Page
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    name += " LoginName='" + this.txtLoginName.Value.Trim() + "' and";
        //}
        //if (this.txtCompanyName.Value != "")
        //{
        //    name += " CompanyName='" + this.txtCompanyName.Value.Trim() + "' and";
        //}
        //if (this.ddlStatus.SelectedValue != "-1")
        //{
        //    name += " AuditingStatus='" + this.ddlStatus.SelectedValue.Trim() + "' and";
        //}
        if (this.txtLoginName.Value != "")
        {
    ...
    protected void btnSel_Click(object sender, EventArgs e)
    {
        ...
        foreach (string str in values)
        {
            ...
            {
                //静态页面生成
                csbll.ComPanyHtml(str, com.LoginName, com.CompanyName, com.IndustryName, com.RangeName, com.NatureName, com.Htmlfile,
                    com.EstablishMent,Convert.ToString(com.Employees),Convert.ToString(com.Capital),com.Introduction,
                    com.ServiceProce,com.Title,com.Keywords,com.Description,com.Logo);
            }
        }
        if (sb.ToString() != "")
        {
