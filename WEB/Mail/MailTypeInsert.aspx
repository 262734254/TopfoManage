<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MailTypeInsert.aspx.cs" Inherits="Mail_MailTypeInsert" %>
...
<body>
    ...
    <tr id="showshenhes" runat ="server" style =" display :none;"><td>审核：</td><td >
        ...
        <asp:TextBox ID="txtdesctption"   runat="server" TextMode="MultiLine"  Width="396px" Height="94px"></asp:TextBox>&nbsp;<div id="showd" style ="display:none; color:Red ; font-size:12px">*</div><br />注意事项：添加之后将无法删除该类型！</td></tr>
