<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndustryInsert.aspx.cs" Inherits="Mail_IndustryInsert" %>
...
<body>
    ...
    <tr><td><span style ="color:Red">*</span>行业名称：</td><td >
        ...
        <tr>
        <td>是否有效：</td>
        <td><asp:RadioButtonList runat="server" ID="rbtIsShow" RepeatDirection="Horizontal" RepeatLayout="Flow">
        <asp:ListItem Value="0" Selected="True">否</asp:ListItem>
        <asp:ListItem Value="1">是</asp:ListItem>
        </asp:RadioButtonList></td>
        </tr>
    <tr><td colspan="2" align="center">
        <asp:Button ID="btnSave" runat="server" OnClientClick="return postnewtabs()" CssClass="btn"  Text="发 布" OnClick="btnSave_Click" /> &nbsp;&nbsp;<input type="button" id="Button3" onclick="window.location.href='IndustryManage.aspx'" value="返 回" class="btn" /></td></tr>
    </table>
    </div>
    </form>
