<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MailSuperInsert.aspx.cs" Inherits="Mail_MailSuperInsert" %>
...
<body>
        ...
        <div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="one_table">
                ...
                <tr>
                  <td>电话</td>
                  <td>
                        <input id="txtTelCountry" readonly="readonly" onkeyup="value=value.replace(/[^0-9]/g,'')" runat="server" type="text" size='4' value="+86" />
                        <input id="txtTelZoneCode" onkeyup="value=value.replace(/[^0-9]/g,'')" runat="server" type="text" size='7' />
                        <input id="txtTelNumber" onkeyup="value=value.replace(/[^0-9]/g,'')" runat="server" type="text" size='18' />
                        <span id="spTel"></span>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Button ID="btnSave" runat="server" OnClientClick="return postnewtabs()" CssClass="btn"
                            Text="发 布" OnClick="btnSave_Click" />
                        &nbsp;&nbsp;<input type="button" id="Button3" onclick="javascript:location.href='MailSupervise.aspx'"
    ...
    <div id="imgLoding" style="position: absolute; display: none; background-color: #A9A9A9;
        top: 0px; left: 0px; width: 100%; height: 1135px; filter: alpha(opacity=60);"
        runat="server">
