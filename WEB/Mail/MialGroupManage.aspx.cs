...
public partial class Mail_MialGroupManage : Tz888.Common.Pager.BasePage
{
    ...
    private void BindShow()
    {
        ...
        this.Pager1.TableViewName = "Mialgroup,#,@";
        this.Pager1.KeyColumn = "groupID";
        this.Pager1.SelectColumns = "*";
        this.Pager1.SortColumn = "groupID";
