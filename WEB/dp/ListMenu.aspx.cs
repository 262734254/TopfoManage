...
using System.Text;
public partial class dp_ListMenu : System.Web.UI.Page//BasePage
{
    public string array = "";
    public int MenuCount = 0;
    Tz888.BLL.dp.SysMenuTab bll = new Tz888.BLL.dp.SysMenuTab();
    Tz888.Model.dp.SysMenuTab model = new Tz888.Model.dp.SysMenuTab();
    Tz888.BLL.dp.SysPermissionTab sysBll = new Tz888.BLL.dp.SysPermissionTab();
    Tz888.Model.dp.SysPermissionTab modelpER = new Tz888.Model.dp.SysPermissionTab();
    Tz888.Model.dp.SysRoleTab roleModel = new Tz888.Model.dp.SysRoleTab();
    DataSet ds = null;
    Tz888.BLL.dp.SysRoleTab roleBll = new Tz888.BLL.dp.SysRoleTab();
    int roleID = 0;
    ...
    {
        IList<Tz888.Model.dp.SysMenuTab> menu = bll.GetList();
