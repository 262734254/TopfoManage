...
public partial class dp_MenuList3 : System.Web.UI.Page//BasePage
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
...

        {
            case "check":
                ...
                break;
            //case "xiaji"://添加一下级菜单
            //    Response.Redirect("MenuList3.aspx?sid=" + sid);
            //    break;
            case "modefiy": //修改
                Response.Redirect("ModefiyMenu.aspx?sid=" + sid + "&ji=3");
                break;
            case "Del"://删除
                //bll.Delete(sid);
                //databind(ViewState["order"].ToString());
    ...
    {
        Response.Redirect("AddMenu.aspx?parentCode=" + Convert.ToInt32(ViewState["parentCode"].ToString()) + "&ji=3");
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("MenuList2.aspx?sid="+ id);
    }
}
